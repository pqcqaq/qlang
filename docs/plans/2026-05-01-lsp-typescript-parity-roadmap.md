...
- `callHierarchy` 已覆盖同文件 function / method 直接调用的 prepare / incoming / outgoing calls
- `typeHierarchy` 已覆盖同文件 trait / struct / enum / type alias 的 prepare / supertypes / subtypes
