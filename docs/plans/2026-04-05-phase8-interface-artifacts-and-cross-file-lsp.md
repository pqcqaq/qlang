...
- imported dependency enum alias root 允许最小 variant completion + hover / definition，但这条合同当前不自动扩展到 struct field、method、更广义 dependency member completion，或 variant references
