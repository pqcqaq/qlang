...
- diagnostics primary-only label -> no related-information parity
- diagnostics secondary-label order and message-fallback parity
- diagnostics unlabeled source and empty related-information parity
