...
- 更广义的 async executable / program bootstrap：当前仅完成 `BuildEmit::LlvmIr` / `BuildEmit::Object` / `BuildEmit::Executable` 下 `async fn main` 的最小程序入口生命周期；更复杂的 bootstrap / 更广 program surface 仍需独立计划
