...
- LSP 还不是稳定 workspace service；主要编辑请求已开始共享 workspace request context，diagnostics、formatting 和 workspace/symbol 已拆出独立模块；持久 workspace index/cache 生命周期仍需要继续统一。
