...
- `hover`、`definition`、`declaration`、`typeDefinition`、`codeLens`、`implementation`、`references`、`documentHighlight` 已共享 workspace request context，统一 package analysis、open document overlay 和当前文档 analysis 准备。
...
- LSP 还不是稳定 workspace service；部分请求已共享 workspace request context，但 diagnostics、references、rename、symbols 和 rich editor hints 仍需要统一 workspace index/cache。
