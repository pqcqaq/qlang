...
- `ql run` 已用真实 smoke 覆盖 dependency public functions/values/types/methods/traits，以及 direct dependency generic public functions、transitive generic wrapper/helper specialization 和 dependency generic JSON 输出。
