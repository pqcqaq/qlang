...
- `ql project init/add/remove/status/dependencies/dependents/targets/graph/lock/emit-interface` 已可维护本地 workspace；`project init` scaffold 文件创建使用 create-new 语义，同一路径并发初始化有真实 CLI smoke。
