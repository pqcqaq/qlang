...
- `ql check/fmt/mir/ownership/runtime/build/run/test/project/ffi` 已实现；`check/build/run/test/fmt`、`mir/ownership/runtime`、`project status/targets/graph/dependencies/dependents/lock/target add/emit-interface` 的参数校验有真实 CLI smoke。
