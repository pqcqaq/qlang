...
- `ql run` 已用真实 smoke 覆盖 dependency public functions/values/types/methods/traits、direct dependency generic public functions、workspace `--package` dependency generic、transitive generic wrapper/helper specialization 和 dependency generic JSON 输出。
