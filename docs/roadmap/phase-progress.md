...
- `ql-codegen-llvm` 已打开只读 place projection lowering：当前嵌套 struct field read、constant tuple index read、array index read 已进入统一 place/type 推导与 LLVM GEP 链 lowering；这条切片仍刻意不开放 projection assignment target
