...
- LSP 下一步重点是把 diagnostics、documentLink、workspace/symbol 等请求继续收敛到统一 workspace analysis/cache 边界；formatting、folding/selection、signatureHelp/inlayHint、codeLens 已进入真实 stdlib request-family gate，dependency import documentLink 已覆盖真实 stdlib workspace。
