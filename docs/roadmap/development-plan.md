...
- LSP 下一步重点是把 diagnostics、formatting、folding/selection、signatureHelp/inlayHint、documentLink、codeLens 等请求收敛到统一 workspace analysis/cache 边界；dependency import documentLink 已覆盖真实 stdlib workspace。
