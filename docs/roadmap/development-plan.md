...
- LSP 下一步重点是把跨请求 workspace analysis/cache 实现继续收敛，减少各请求重复扫描；diagnostics 已覆盖真实 stdlib app/source/open-buffer 场景，workspace/symbol 已覆盖 real stdlib open/change/close 生命周期，formatting、folding/selection、signatureHelp/inlayHint、documentLink、codeLens 已进入真实 stdlib request-family gate。
