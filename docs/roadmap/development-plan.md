...
- LSP 下一步重点是把 diagnostics、workspace/symbol 和跨请求 index 生命周期继续收敛到统一 workspace analysis/cache 边界；formatting、folding/selection、signatureHelp/inlayHint、documentLink、codeLens 已进入真实 stdlib request-family gate。
