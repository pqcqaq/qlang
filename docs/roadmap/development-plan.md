...
- LSP 下一步重点是把跨请求 index 生命周期继续收敛到统一 workspace analysis/cache 边界；diagnostics 已覆盖真实 stdlib app/source/open-buffer 场景，workspace/symbol、formatting、folding/selection、signatureHelp/inlayHint、documentLink、codeLens 已进入真实 stdlib request-family gate。
