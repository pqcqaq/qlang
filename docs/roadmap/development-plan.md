...
- 建立 LSP workspace index；真实 stdlib package 请求 smoke 已覆盖 current API 的 completion、hover、definition、typeDefinition、references、documentHighlight、signatureHelp、inlayHint、foldingRange、selectionRange、formatting、semantic tokens 和 rename，专门 smoke 已覆盖真实 stdlib diagnostics、codeLens 和 `workspace/symbol`。下一步继续把 diagnostics、formatting、folding/selection、signatureHelp/inlayHint、codeLens 等请求收敛到统一 workspace analysis/cache 边界。
