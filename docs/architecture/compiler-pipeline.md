...
- 当前 rename 也仍刻意保守：目前只开放 function / const / static / struct / enum / variant / trait / type alias / local / parameter / generic 的同文件重命名；field / method / receiver / import / builtin type 以及 cross-file rename 仍需更完整查询面后再开放
