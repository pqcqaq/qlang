...
这套 stdlib 当前使用已稳定的 direct local dependency bridge，以及受限 generic public free function 单实例特化；自动 prelude、完整泛型单态化、泛型集合、IO、字符串完整库面和 registry/version solving 都继续后置。
