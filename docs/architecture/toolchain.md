...
- `stdlib/packages/core`：package `std.core`，提供 `max_int`、`min_int`、`clamp_int`、`abs_int`、`sign_int`、`is_even_int`、`is_odd_int`、`in_range_int`、`bool_to_int`。
- `stdlib/packages/test`：package `std.test`，提供 `expect_true`、`expect_false`、`expect_int_eq`、`expect_zero`、`expect_nonzero`。
