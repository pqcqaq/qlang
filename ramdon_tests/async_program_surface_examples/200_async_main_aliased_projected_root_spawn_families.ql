...
async fn main() -> Int {
    ...
    let arithmetic_const_composed_tasks = [
        arithmetic_const_composed_alias[arithmetic_const_slot_alias[arithmetic_const_row]],
        worker(5),
    ]
    let arithmetic_const_composed_running = spawn arithmetic_const_composed_tasks[0]
    let arithmetic_const_composed_second = await arithmetic_const_composed_running
    let arithmetic_const_composed_extra = await arithmetic_const_composed_tasks[1]
    ...
    let arithmetic_static_composed_env = ArrayEnvelope {
        bundle: ArrayBundle {
            tasks: [
                forward(arithmetic_static_composed_alias[arithmetic_static_slot_alias[arithmetic_static_row]]),
                worker(7),
            ],
        },
        tail: arithmetic_static_composed_pending.tasks[1],
    }
    let arithmetic_static_composed_running = spawn arithmetic_static_composed_env.bundle.tasks[0]
    let arithmetic_static_composed_second = await arithmetic_static_composed_running
    let arithmetic_static_composed_extra = await arithmetic_static_composed_env.bundle.tasks[1]
    ...
    let guarded_arithmetic_const_tasks = [
        guarded_arithmetic_const_alias[guarded_arithmetic_const_slot_alias[guarded_arithmetic_const_row]],
        worker(4),
    ]
    let guarded_arithmetic_const_running = spawn guarded_arithmetic_const_tasks[0]
    let guarded_arithmetic_const_second = await guarded_arithmetic_const_running
    let guarded_arithmetic_const_extra = await guarded_arithmetic_const_tasks[1]
    ...
    let guarded_arithmetic_static_env = ArrayEnvelope {
        bundle: ArrayBundle {
            tasks: [
                forward(guarded_arithmetic_static_alias[guarded_arithmetic_static_slot_alias[guarded_arithmetic_static_row]]),
                worker(5),
            ],
        },
        tail: guarded_arithmetic_static_pending.tasks[1],
    }
    let guarded_arithmetic_static_running = spawn guarded_arithmetic_static_env.bundle.tasks[0]
    let guarded_arithmetic_static_second = await guarded_arithmetic_static_running
    let guarded_arithmetic_static_extra = await guarded_arithmetic_static_env.bundle.tasks[1]
    ...
    let guarded_arithmetic_bundle_env = ArrayEnvelope {
        bundle: ArrayBundle {
            tasks: [guarded_arithmetic_bundle_running_task, worker(9)],
        },
    ...
    let guarded_arithmetic_bundle_running = spawn guarded_arithmetic_bundle_ready
    let guarded_arithmetic_bundle_second = await guarded_arithmetic_bundle_running
    ...
    let guarded_arithmetic_bundle_inline_row = ARITH_SLOT_ALIAS.value
    let guarded_arithmetic_bundle_inline_slots = [guarded_arithmetic_bundle_inline_row, guarded_arithmetic_bundle_inline_row]
    let guarded_arithmetic_bundle_inline_slot_alias = guarded_arithmetic_bundle_inline_slots
    var guarded_arithmetic_bundle_inline_pending = Pending {
        tasks: [worker(2), worker(6)],
    }
    let guarded_arithmetic_bundle_inline_alias = guarded_arithmetic_bundle_inline_pending.tasks
    if ARITH_SLOT_ALIAS.value == 0 {
        let guarded_arithmetic_bundle_inline_first =
            await guarded_arithmetic_bundle_inline_alias[guarded_arithmetic_bundle_inline_slot_alias[guarded_arithmetic_bundle_inline_row]]
        guarded_arithmetic_bundle_inline_pending.tasks[guarded_arithmetic_bundle_inline_slots[guarded_arithmetic_bundle_inline_row]] =
            worker(guarded_arithmetic_bundle_inline_first + 5)
    }
    let guarded_arithmetic_bundle_inline_tail_tasks = guarded_arithmetic_bundle_inline_pending.tasks
    let guarded_arithmetic_bundle_inline_forwarded =
        forward(guarded_arithmetic_bundle_inline_alias[guarded_arithmetic_bundle_inline_slot_alias[guarded_arithmetic_bundle_inline_row]])
    let guarded_arithmetic_bundle_inline_running_task = guarded_arithmetic_bundle_inline_forwarded
    let guarded_arithmetic_bundle_inline_env = ArrayEnvelope {
        bundle: ArrayBundle {
            tasks: [guarded_arithmetic_bundle_inline_running_task, worker(13)],
        },
        tail: guarded_arithmetic_bundle_inline_tail_tasks[1],
    }
    let guarded_arithmetic_bundle_inline_root = guarded_arithmetic_bundle_inline_env.bundle.tasks
    let guarded_arithmetic_bundle_inline_tasks = guarded_arithmetic_bundle_inline_root
    let guarded_arithmetic_bundle_inline_running =
        spawn forward(guarded_arithmetic_bundle_inline_tasks[0])
    let guarded_arithmetic_bundle_inline_second =
        await guarded_arithmetic_bundle_inline_running
    let guarded_arithmetic_bundle_inline_extra =
        await guarded_arithmetic_bundle_inline_env.bundle.tasks[1]
    let guarded_arithmetic_bundle_inline_tail = await guarded_arithmetic_bundle_inline_env.tail

    let guarded_arithmetic_bundle_chain_inline_row = ARITH_SLOT_ALIAS.value
    let guarded_arithmetic_bundle_chain_inline_slots = [guarded_arithmetic_bundle_chain_inline_row, guarded_arithmetic_bundle_chain_inline_row]
    let guarded_arithmetic_bundle_chain_inline_slot_alias = guarded_arithmetic_bundle_chain_inline_slots
    var guarded_arithmetic_bundle_chain_inline_pending = Pending {
        tasks: [worker(2), worker(7)],
    }
    let guarded_arithmetic_bundle_chain_inline_alias = guarded_arithmetic_bundle_chain_inline_pending.tasks
    if ARITH_SLOT_ALIAS.value == 0 {
        let guarded_arithmetic_bundle_chain_inline_first =
            await guarded_arithmetic_bundle_chain_inline_alias[guarded_arithmetic_bundle_chain_inline_slot_alias[guarded_arithmetic_bundle_chain_inline_row]]
        guarded_arithmetic_bundle_chain_inline_pending.tasks[guarded_arithmetic_bundle_chain_inline_slots[guarded_arithmetic_bundle_chain_inline_row]] =
            worker(guarded_arithmetic_bundle_chain_inline_first + 6)
    }
    let guarded_arithmetic_bundle_chain_inline_tail_tasks = guarded_arithmetic_bundle_chain_inline_pending.tasks
    let guarded_arithmetic_bundle_chain_inline_forwarded =
        forward(guarded_arithmetic_bundle_chain_inline_alias[guarded_arithmetic_bundle_chain_inline_slot_alias[guarded_arithmetic_bundle_chain_inline_row]])
    let guarded_arithmetic_bundle_chain_inline_running_task = guarded_arithmetic_bundle_chain_inline_forwarded
    let guarded_arithmetic_bundle_chain_inline_env = ArrayEnvelope {
        bundle: ArrayBundle {
            tasks: [guarded_arithmetic_bundle_chain_inline_running_task, worker(15)],
        },
        tail: guarded_arithmetic_bundle_chain_inline_tail_tasks[1],
    }
    let guarded_arithmetic_bundle_chain_inline_root =
        guarded_arithmetic_bundle_chain_inline_env.bundle.tasks
    let guarded_arithmetic_bundle_chain_inline_alias_root =
        guarded_arithmetic_bundle_chain_inline_root
    let guarded_arithmetic_bundle_chain_inline_tasks =
        guarded_arithmetic_bundle_chain_inline_alias_root
    let guarded_arithmetic_bundle_chain_inline_running =
        spawn forward(guarded_arithmetic_bundle_chain_inline_tasks[0])
    let guarded_arithmetic_bundle_chain_inline_second =
        await guarded_arithmetic_bundle_chain_inline_running
    let guarded_arithmetic_bundle_chain_inline_extra =
        await guarded_arithmetic_bundle_chain_inline_env.bundle.tasks[1]
    let guarded_arithmetic_bundle_chain_inline_tail =
        await guarded_arithmetic_bundle_chain_inline_env.tail
    ...
    let guarded_arithmetic_queued_env = ArrayEnvelope {
        bundle: ArrayBundle {
            tasks: [guarded_arithmetic_queued_running_task, worker(11)],
        },
    ...
    let guarded_arithmetic_queued_running = spawn guarded_arithmetic_queued_ready
    let guarded_arithmetic_queued_second = await guarded_arithmetic_queued_running
    ...
    let guarded_arithmetic_queued_root_inline_env = ArrayEnvelope {
        bundle: ArrayBundle {
            tasks: [guarded_arithmetic_queued_root_inline_running_task, worker(17)],
        },
    ...
    let guarded_arithmetic_queued_root_inline_running =
        spawn forward(guarded_arithmetic_queued_root_inline_tasks[0])
    let guarded_arithmetic_queued_root_inline_second =
        await guarded_arithmetic_queued_root_inline_running
    ...
    let guarded_arithmetic_queued_root_alias_env = ArrayEnvelope {
        bundle: ArrayBundle {
            tasks: [guarded_arithmetic_queued_root_alias_running_task, worker(19)],
        },
    ...
    let guarded_arithmetic_queued_root_alias_running = spawn guarded_arithmetic_queued_root_alias_ready
    let guarded_arithmetic_queued_root_alias_second = await guarded_arithmetic_queued_root_alias_running
    ...
    let guarded_arithmetic_queued_root_alias_inline_env = ArrayEnvelope {
        bundle: ArrayBundle {
            tasks: [guarded_arithmetic_queued_root_alias_inline_running_task, worker(23)],
        },
    ...
    let guarded_arithmetic_queued_root_alias_inline_running =
        spawn forward(guarded_arithmetic_queued_root_alias_inline)
    let guarded_arithmetic_queued_root_alias_inline_second =
        await guarded_arithmetic_queued_root_alias_inline_running
    ...
    let guarded_arithmetic_queued_root_chain_inline_env = ArrayEnvelope {
        bundle: ArrayBundle {
            tasks: [guarded_arithmetic_queued_root_chain_inline_running_task, worker(25)],
        },
    ...
    let guarded_arithmetic_queued_root_chain_inline_running =
        spawn forward(guarded_arithmetic_queued_root_chain_inline)
    let guarded_arithmetic_queued_root_chain_inline_second =
        await guarded_arithmetic_queued_root_chain_inline_running
    ...
    let guarded_arithmetic_queued_root_chain_env = ArrayEnvelope {
        bundle: ArrayBundle {
            tasks: [guarded_arithmetic_queued_root_chain_running_task, worker(21)],
        },
    ...
    let guarded_arithmetic_queued_root_chain_running = spawn guarded_arithmetic_queued_root_chain_ready
    let guarded_arithmetic_queued_root_chain_second = await guarded_arithmetic_queued_root_chain_running
    ...
    let guarded_arithmetic_queued_local_env = ArrayEnvelope {
        bundle: ArrayBundle {
            tasks: [guarded_arithmetic_queued_local_running_task, worker(13)],
        },
    ...
    let guarded_arithmetic_queued_local_running = spawn guarded_arithmetic_queued_local_ready
    let guarded_arithmetic_queued_local_second = await guarded_arithmetic_queued_local_running
    ...
    let guarded_arithmetic_queued_local_alias_row = ARITH_SLOT_ALIAS.value
    let guarded_arithmetic_queued_local_alias_slots = [guarded_arithmetic_queued_local_alias_row, guarded_arithmetic_queued_local_alias_row]
    let guarded_arithmetic_queued_local_alias_slot_alias = guarded_arithmetic_queued_local_alias_slots
    var guarded_arithmetic_queued_local_alias_pending = Pending {
        tasks: [worker(2), worker(10)],
    }
    let guarded_arithmetic_queued_local_alias_source = guarded_arithmetic_queued_local_alias_pending.tasks
    if ARITH_SLOT_ALIAS.value == 0 {
        let guarded_arithmetic_queued_local_alias_first =
            await guarded_arithmetic_queued_local_alias_source[guarded_arithmetic_queued_local_alias_slot_alias[guarded_arithmetic_queued_local_alias_row]]
        guarded_arithmetic_queued_local_alias_pending.tasks[guarded_arithmetic_queued_local_alias_slots[guarded_arithmetic_queued_local_alias_row]] =
            worker(guarded_arithmetic_queued_local_alias_first + 9)
    }
    let guarded_arithmetic_queued_local_alias_tail_tasks = guarded_arithmetic_queued_local_alias_pending.tasks
    let guarded_arithmetic_queued_local_alias_forwarded =
        forward(guarded_arithmetic_queued_local_alias_source[guarded_arithmetic_queued_local_alias_slot_alias[guarded_arithmetic_queued_local_alias_row]])
    let guarded_arithmetic_queued_local_alias_running_task = guarded_arithmetic_queued_local_alias_forwarded
    let guarded_arithmetic_queued_local_alias_env = ArrayEnvelope {
        bundle: ArrayBundle {
            tasks: [guarded_arithmetic_queued_local_alias_running_task, worker(27)],
        },
        tail: guarded_arithmetic_queued_local_alias_tail_tasks[1],
    }
    let guarded_arithmetic_queued_local_alias_root = guarded_arithmetic_queued_local_alias_env.bundle.tasks
    let guarded_arithmetic_queued_local_alias_alias_root = guarded_arithmetic_queued_local_alias_root
    let guarded_arithmetic_queued_local_alias_tasks = guarded_arithmetic_queued_local_alias_alias_root
    let guarded_arithmetic_queued_local_alias = guarded_arithmetic_queued_local_alias_tasks[0]
    let guarded_arithmetic_queued_local_alias_task = guarded_arithmetic_queued_local_alias
    let guarded_arithmetic_queued_local_alias_running = spawn guarded_arithmetic_queued_local_alias_task
    let guarded_arithmetic_queued_local_alias_second = await guarded_arithmetic_queued_local_alias_running
    let guarded_arithmetic_queued_local_alias_extra =
        await guarded_arithmetic_queued_local_alias_env.bundle.tasks[1]
    let guarded_arithmetic_queued_local_alias_tail = await guarded_arithmetic_queued_local_alias_env.tail

    let guarded_arithmetic_queued_local_chain_row = ARITH_SLOT_ALIAS.value
    let guarded_arithmetic_queued_local_chain_slots = [guarded_arithmetic_queued_local_chain_row, guarded_arithmetic_queued_local_chain_row]
    let guarded_arithmetic_queued_local_chain_slot_alias = guarded_arithmetic_queued_local_chain_slots
    var guarded_arithmetic_queued_local_chain_pending = Pending {
        tasks: [worker(2), worker(11)],
    }
    let guarded_arithmetic_queued_local_chain_source = guarded_arithmetic_queued_local_chain_pending.tasks
    if ARITH_SLOT_ALIAS.value == 0 {
        let guarded_arithmetic_queued_local_chain_first =
            await guarded_arithmetic_queued_local_chain_source[guarded_arithmetic_queued_local_chain_slot_alias[guarded_arithmetic_queued_local_chain_row]]
        guarded_arithmetic_queued_local_chain_pending.tasks[guarded_arithmetic_queued_local_chain_slots[guarded_arithmetic_queued_local_chain_row]] =
            worker(guarded_arithmetic_queued_local_chain_first + 10)
    }
    let guarded_arithmetic_queued_local_chain_tail_tasks = guarded_arithmetic_queued_local_chain_pending.tasks
    let guarded_arithmetic_queued_local_chain_forwarded =
        forward(guarded_arithmetic_queued_local_chain_source[guarded_arithmetic_queued_local_chain_slot_alias[guarded_arithmetic_queued_local_chain_row]])
    let guarded_arithmetic_queued_local_chain_running_task = guarded_arithmetic_queued_local_chain_forwarded
    let guarded_arithmetic_queued_local_chain_env = ArrayEnvelope {
        bundle: ArrayBundle {
            tasks: [guarded_arithmetic_queued_local_chain_running_task, worker(29)],
        },
        tail: guarded_arithmetic_queued_local_chain_tail_tasks[1],
    }
    let guarded_arithmetic_queued_local_chain_root = guarded_arithmetic_queued_local_chain_env.bundle.tasks
    let guarded_arithmetic_queued_local_chain_alias_root = guarded_arithmetic_queued_local_chain_root
    let guarded_arithmetic_queued_local_chain_tasks = guarded_arithmetic_queued_local_chain_alias_root
    let guarded_arithmetic_queued_local_chain = guarded_arithmetic_queued_local_chain_tasks[0]
    let guarded_arithmetic_queued_local_chain_alias_task = guarded_arithmetic_queued_local_chain
    let guarded_arithmetic_queued_local_chain_final = guarded_arithmetic_queued_local_chain_alias_task
    let guarded_arithmetic_queued_local_chain_running = spawn guarded_arithmetic_queued_local_chain_final
    let guarded_arithmetic_queued_local_chain_second = await guarded_arithmetic_queued_local_chain_running
    let guarded_arithmetic_queued_local_chain_extra =
        await guarded_arithmetic_queued_local_chain_env.bundle.tasks[1]
    let guarded_arithmetic_queued_local_chain_tail = await guarded_arithmetic_queued_local_chain_env.tail
    ...
    let guarded_arithmetic_queued_local_inline_env = ArrayEnvelope {
        bundle: ArrayBundle {
            tasks: [guarded_arithmetic_queued_local_inline_running_task, worker(15)],
        },
    ...
    let guarded_arithmetic_queued_local_inline_running = spawn forward(guarded_arithmetic_queued_local_inline_final)
    let guarded_arithmetic_queued_local_inline_second = await guarded_arithmetic_queued_local_inline_running
    ...
    let guarded_arithmetic_chain_env = ArrayEnvelope {
        bundle: ArrayBundle {
            tasks: [guarded_arithmetic_chain_running_task, worker(10)],
        },
    ...
    let guarded_arithmetic_chain_running = spawn guarded_arithmetic_chain_ready
    let guarded_arithmetic_chain_second = await guarded_arithmetic_chain_running
    ...
    return nested_second
        ...
        + guarded_arithmetic_bundle_inline_second
        + guarded_arithmetic_bundle_inline_extra
        + guarded_arithmetic_bundle_inline_tail
        + guarded_arithmetic_bundle_chain_inline_second
        + guarded_arithmetic_bundle_chain_inline_extra
        + guarded_arithmetic_bundle_chain_inline_tail
        ...
        + guarded_arithmetic_queued_local_alias_second
        + guarded_arithmetic_queued_local_alias_extra
        + guarded_arithmetic_queued_local_alias_tail
        + guarded_arithmetic_queued_local_chain_second
        + guarded_arithmetic_queued_local_chain_extra
        + guarded_arithmetic_queued_local_chain_tail
