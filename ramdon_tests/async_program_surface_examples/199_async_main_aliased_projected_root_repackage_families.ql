...
async fn main() -> Int {
    ...
    let guarded_arithmetic_bundle_inline_env = ArrayEnvelope {
        bundle: ArrayBundle {
            tasks: [guarded_arithmetic_bundle_inline_running_task, worker(12)],
        },
    ...
    let guarded_arithmetic_bundle_inline_second =
        await forward(guarded_arithmetic_bundle_inline_tasks[0])
    ...
    let guarded_arithmetic_bundle_chain_inline_env = ArrayEnvelope {
        bundle: ArrayBundle {
            tasks: [guarded_arithmetic_bundle_chain_inline_running_task, worker(14)],
        },
    ...
    let guarded_arithmetic_bundle_chain_inline_second =
        await forward(guarded_arithmetic_bundle_chain_inline_tasks[0])
    ...
    let guarded_arithmetic_queued_local_alias_env = ArrayEnvelope {
        bundle: ArrayBundle {
            tasks: [guarded_arithmetic_queued_local_alias_running_task, worker(26)],
        },
    ...
    let guarded_arithmetic_queued_local_alias_second = await guarded_arithmetic_queued_local_alias_task
    ...
    let guarded_arithmetic_queued_local_chain_env = ArrayEnvelope {
        bundle: ArrayBundle {
            tasks: [guarded_arithmetic_queued_local_chain_running_task, worker(28)],
        },
    ...
    let guarded_arithmetic_queued_local_chain_second = await guarded_arithmetic_queued_local_chain_final
