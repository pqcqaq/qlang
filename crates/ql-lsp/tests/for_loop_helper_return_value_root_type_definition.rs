...
#[test]
fn type_definition_bridge_follows_dependency_for_loop_helper_tuple_bindings() {
    run_type_definition_case(BindingKind::HelperTuple);
}

#[test]
fn type_definition_bridge_follows_dependency_for_loop_helper_array_bindings() {
    run_type_definition_case(BindingKind::HelperArray);
}
