...
"#,
        function_root = StructuredKind::If.wrap("load_cfg()?"),
        static_root = StructuredKind::Match.wrap("maybe_cfg?"),
    );
    ...
    .expect("structured grouped question function field definition should exist");
    ...
    .expect("structured grouped question static field definition should exist");
...
"#,
        function_root = StructuredKind::Match.wrap("load_cfg()?"),
        static_root = StructuredKind::If.wrap("maybe_cfg?"),
    );
    temp.write("workspace/app/src/lib.ql", &source);
    ...
    .expect("structured grouped question function method definition should exist");
    ...
    .expect("structured grouped question static method definition should exist");
