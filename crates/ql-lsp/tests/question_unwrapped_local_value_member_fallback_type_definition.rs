...
fn type_definition_fallback_follows_question_unwrapped_local_field_member_types() {
    let temp = TempDir::new("ql-lsp-question-unwrapped-local-value-member-type-definition-broken");
...
"#;
    ...
    .expect(
        "question-unwrapped local member type definition should exist without semantic analysis",
    );
