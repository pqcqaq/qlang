...
#[test]
fn root_query_bridge_surfaces_dependency_for_loop_method_array_bindings() {
    run_root_query_case(BindingKind::MethodArray);
}

#[test]
fn root_query_bridge_surfaces_dependency_for_loop_method_tuple_bindings() {
    run_root_query_case(BindingKind::MethodTuple);
}
