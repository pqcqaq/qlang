...
"#,
    ...
    if broken {
        ...
        .expect("dependency method-return value root hover should exist");
        ...
        .expect("dependency method-return value root definition should exist");
        ...
        .expect("dependency method-return value root declaration should exist");
        ...
        .expect("dependency method-return value root references should exist");
        assert_eq!(
            without_declaration,
            vec![
                Location::new(
        ...
        .expect("dependency method-return value root references with declaration should exist");
...
#[test]
fn root_query_bridge_surfaces_dependency_for_loop_method_array_value_roots() {
    run_root_query_case(BindingKind::MethodArray, false);
}

#[test]
fn root_query_bridge_surfaces_dependency_for_loop_method_tuple_value_roots() {
    run_root_query_case(BindingKind::MethodTuple, false);
}

#[test]
fn root_query_fallback_surfaces_dependency_for_loop_method_array_value_roots() {
    run_root_query_case(BindingKind::MethodArray, true);
}

#[test]
fn root_query_fallback_surfaces_dependency_for_loop_method_tuple_value_roots() {
    run_root_query_case(BindingKind::MethodTuple, true);
}
