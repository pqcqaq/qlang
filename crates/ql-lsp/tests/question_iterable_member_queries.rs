...
fn run_member_query_case(root: RootKind, member: MemberKind, broken: bool) {
    let temp = TempDir::new(&format!(
        "ql-lsp-question-iterable-{}-{}-member-query{}",
        root.label(),
        member.label(),
...
#[test]
fn dependency_field_queries_work_on_question_function_iterable_receivers() {
    run_member_query_case(RootKind::Function, MemberKind::Field, false);
}

#[test]
fn dependency_field_queries_work_on_question_function_iterable_receivers_without_semantic_analysis()
{
    run_member_query_case(RootKind::Function, MemberKind::Field, true);
}

#[test]
fn dependency_method_queries_work_on_question_function_iterable_receivers() {
...
#[test]
fn dependency_field_queries_work_on_question_static_iterable_receivers() {
    run_member_query_case(RootKind::Static, MemberKind::Field, false);
}

#[test]
fn dependency_field_queries_work_on_question_static_iterable_receivers_without_semantic_analysis() {
    run_member_query_case(RootKind::Static, MemberKind::Field, true);
}

#[test]
fn dependency_method_queries_work_on_question_static_iterable_receivers() {
    run_member_query_case(RootKind::Static, MemberKind::Method, false);
}

#[test]
fn dependency_method_queries_work_on_question_static_iterable_receivers_without_semantic_analysis()
{
