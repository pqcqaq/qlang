...
#[test]
fn type_definition_bridge_follows_question_unwrapped_dependency_field_types() {
    let temp = TempDir::new("ql-lsp-question-field-type-definition");
...
"#;
    ...
    .expect("dependency method return type definition should exist without semantic analysis");
    assert_targets_dependency_type(
        definition,
        &dep_qi,
        "pub struct Child {\n    value: Int,\n}",
...
#[test]
fn type_definition_bridge_follows_question_unwrapped_dependency_field_types_without_semantic_analysis()
 {
    let temp = TempDir::new("ql-lsp-question-field-type-definition-broken");
    let app_root = temp.path().join("workspace").join("app");
...
"#;
    ...
    .expect("dependency field type definition should exist without semantic analysis");
    assert_targets_dependency_type(
        definition,
        &dep_qi,
        "pub struct Child {\n    value: Int,\n}",
