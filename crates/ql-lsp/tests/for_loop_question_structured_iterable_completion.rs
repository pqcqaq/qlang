...
fn run_completion_case(member: MemberKind, broken: bool) {
    let temp = TempDir::new(&format!(
        "ql-lsp-for-loop-question-structured-iterable-{}-completion{}",
        member.label(),
...
#[test]
fn dependency_field_completion_works_on_for_loop_if_question_iterable_receivers() {
...
#[test]
fn dependency_method_completion_works_on_for_loop_match_question_iterable_receivers() {
