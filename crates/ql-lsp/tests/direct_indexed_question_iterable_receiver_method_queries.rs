...
fn run_query_case(broken: bool) {
    let temp = TempDir::new(&format!(
        "ql-lsp-direct-indexed-question-iterable-receiver-method-query{}",
...
"#,
    ...
    if broken {
        ...
        .expect("direct indexed question-iterable receiver method hover should exist");
        ...
        .expect("direct indexed question-iterable receiver method definition should exist");
        ...
        .expect("direct indexed question-iterable receiver method declaration should exist");
        ...
        .expect("direct indexed question-iterable receiver method references should exist");
        ...
        .expect(
            "direct indexed question-iterable receiver method references without declaration should exist",
        );
...
#[test]
fn queries_work_on_direct_indexed_question_iterable_receiver_methods() {
    run_query_case(false);
}

#[test]
fn queries_fallback_on_direct_indexed_question_iterable_receiver_methods() {
    run_query_case(true);
}
