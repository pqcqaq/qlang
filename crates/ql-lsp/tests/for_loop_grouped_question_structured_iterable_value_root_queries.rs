...
#[test]
fn root_query_fallback_surfaces_dependency_for_loop_if_grouped_question_function_bindings() {
    run_root_query_case(RootKind::Function, StructuredKind::If, true);
}

#[test]
fn root_query_fallback_surfaces_dependency_for_loop_match_grouped_question_function_bindings() {
    run_root_query_case(RootKind::Function, StructuredKind::Match, true);
}

#[test]
fn root_query_fallback_surfaces_dependency_for_loop_if_grouped_question_static_bindings() {
    run_root_query_case(RootKind::Static, StructuredKind::If, true);
}

#[test]
fn root_query_fallback_surfaces_dependency_for_loop_match_grouped_question_static_bindings() {
