...
"#,
    ...
    if broken {
        ...
        let definition = type_definition_for_dependency_values(&source, &package, position)
            .expect("dependency question iterable root type definition should exist");
...
#[test]
fn type_definition_bridge_follows_question_function_iterable_roots() {
    run_type_definition_case(RootKind::Function, false);
}

#[test]
fn type_definition_fallback_follows_question_function_iterable_roots() {
    run_type_definition_case(RootKind::Function, true);
}

#[test]
fn type_definition_bridge_follows_question_static_iterable_roots() {
    run_type_definition_case(RootKind::Static, false);
}

#[test]
fn type_definition_fallback_follows_question_static_iterable_roots() {
