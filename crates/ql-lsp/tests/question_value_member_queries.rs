...
#[test]
fn dependency_field_queries_work_on_question_function_value_receivers() {
    run_member_query_case(RootKind::Function, MemberKind::Field, false);
}

#[test]
fn dependency_field_queries_work_on_question_function_value_receivers_without_semantic_analysis() {
    run_member_query_case(RootKind::Function, MemberKind::Field, true);
}

#[test]
fn dependency_method_queries_work_on_question_function_value_receivers() {
    run_member_query_case(RootKind::Function, MemberKind::Method, false);
}

#[test]
fn dependency_method_queries_work_on_question_function_value_receivers_without_semantic_analysis() {
    run_member_query_case(RootKind::Function, MemberKind::Method, true);
}

#[test]
fn dependency_field_queries_work_on_question_static_value_receivers() {
    run_member_query_case(RootKind::Static, MemberKind::Field, false);
}

#[test]
fn dependency_field_queries_work_on_question_static_value_receivers_without_semantic_analysis() {
    run_member_query_case(RootKind::Static, MemberKind::Field, true);
}

#[test]
fn dependency_method_queries_work_on_question_static_value_receivers() {
    run_member_query_case(RootKind::Static, MemberKind::Method, false);
}

#[test]
fn dependency_method_queries_work_on_question_static_value_receivers_without_semantic_analysis() {
