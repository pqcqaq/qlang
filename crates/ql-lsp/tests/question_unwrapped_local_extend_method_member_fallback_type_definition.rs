...
#[test]
fn type_definition_fallback_follows_question_unwrapped_local_extend_method_member_types() {
    let temp =
        TempDir::new("ql-lsp-question-unwrapped-local-extend-method-member-type-definition-broken");
...
"#;
    ...
    .expect(
        "question-unwrapped local extend-member type definition should exist without semantic analysis",
    );
