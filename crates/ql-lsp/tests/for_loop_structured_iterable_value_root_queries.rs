...
fn run_root_query_case(binding: BindingKind, broken: bool) {
    let temp = TempDir::new(&format!(
        "ql-lsp-for-loop-structured-iterable-{}-value-root-query{}",
        binding.label(),
...
"#,
    ...
    if broken {
        ...
        .expect("structured iterable value root hover should exist");
        ...
        .expect("structured iterable value root definition should exist");
        ...
        .expect("structured iterable value root declaration should exist");
        ...
        .expect("structured iterable value root references should exist");
        assert_eq!(
            without_declaration,
            vec![
                Location::new(
        ...
        .expect("structured iterable value root references with declaration should exist");
...
#[test]
fn root_query_bridge_surfaces_dependency_for_loop_if_tuple_structured_iterable_bindings() {
    run_root_query_case(BindingKind::IfTuple, false);
}

#[test]
fn root_query_bridge_surfaces_dependency_for_loop_match_array_structured_iterable_bindings() {
    run_root_query_case(BindingKind::MatchArray, false);
}

#[test]
fn root_query_fallback_surfaces_dependency_for_loop_if_tuple_structured_iterable_bindings() {
    run_root_query_case(BindingKind::IfTuple, true);
}

#[test]
fn root_query_fallback_surfaces_dependency_for_loop_match_array_structured_iterable_bindings() {
    run_root_query_case(BindingKind::MatchArray, true);
}
