...
#[test]
fn type_definition_bridge_follows_dependency_member_method_return_types() {
    let temp = TempDir::new("ql-lsp-method-type-definition");
...
#[test]
fn type_definition_bridge_follows_dependency_member_method_return_types_without_semantic_analysis()
{
    let temp = TempDir::new("ql-lsp-method-type-definition-broken");
    let app_root = temp.path().join("workspace").join("app");
