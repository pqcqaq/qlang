...
pub fn read() -> Int {{
{broken_line}    for current in {receiver} {{
...
"#,
    ...
    if broken {
        ...
        .expect("question iterable member type definition should exist");
...
#[test]
fn type_definition_bridge_follows_question_function_iterable_field_member_types() {
    run_type_definition_case(RootKind::Function, MemberKind::Field, false);
}

#[test]
fn type_definition_fallback_follows_question_function_iterable_field_member_types() {
    run_type_definition_case(RootKind::Function, MemberKind::Field, true);
}

#[test]
fn type_definition_bridge_follows_question_function_iterable_method_member_types() {
    run_type_definition_case(RootKind::Function, MemberKind::Method, false);
}

#[test]
fn type_definition_fallback_follows_question_function_iterable_method_member_types() {
    run_type_definition_case(RootKind::Function, MemberKind::Method, true);
}

#[test]
fn type_definition_bridge_follows_question_static_iterable_field_member_types() {
    run_type_definition_case(RootKind::Static, MemberKind::Field, false);
}

#[test]
fn type_definition_fallback_follows_question_static_iterable_field_member_types() {
    run_type_definition_case(RootKind::Static, MemberKind::Field, true);
}

#[test]
fn type_definition_bridge_follows_question_static_iterable_method_member_types() {
    run_type_definition_case(RootKind::Static, MemberKind::Method, false);
}

#[test]
fn type_definition_fallback_follows_question_static_iterable_method_member_types() {
