...
fn run_root_query_case(broken: bool) {
    let temp = TempDir::new(&format!(
        "ql-lsp-projected-field-alias-value-root-query{}",
...
#[test]
fn root_query_bridge_surfaces_dependency_projected_field_alias_locals() {
    run_root_query_case(false);
}

#[test]
fn root_query_fallback_surfaces_dependency_projected_field_alias_locals() {
