...
#[test]
fn dependency_field_queries_work_on_question_unwrapped_local_extend_method_result_alias_receivers_without_semantic_analysis(
) {
    let temp = TempDir::new(
        "ql-lsp-question-unwrapped-local-extend-method-alias-value-member-query-broken",
    );
...
"#;
    ...
    .expect("dependency extend-method-result alias local field hover should exist without semantic analysis");
    ...
    .expect("dependency extend-method-result alias local field definition should exist without semantic analysis");
    ...
    .expect("dependency extend-method-result alias local field declaration should exist without semantic analysis");
    ...
    .expect("dependency extend-method-result alias local field references should exist without semantic analysis");
    ...
    .expect("dependency extend-method-result alias local field references should exist without declaration");
