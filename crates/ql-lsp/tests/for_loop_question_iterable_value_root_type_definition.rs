...
fn run_type_definition_case(binding: BindingKind, broken: bool) {
    let temp = TempDir::new(&format!(
        "ql-lsp-for-loop-question-iterable-{}-value-root-type-definition{}",
        binding.label(),
...
"#,
    ...
    if broken {
        ...
        .expect("dependency question iterable value root type definition should exist");
...
#[test]
fn type_definition_bridge_follows_dependency_for_loop_question_field_iterable_bindings() {
    run_type_definition_case(BindingKind::Field, false);
}

#[test]
fn type_definition_bridge_follows_dependency_for_loop_question_method_iterable_bindings() {
    run_type_definition_case(BindingKind::Method, false);
}

#[test]
fn type_definition_fallback_follows_dependency_for_loop_question_field_iterable_bindings() {
    run_type_definition_case(BindingKind::Field, true);
}

#[test]
fn type_definition_fallback_follows_dependency_for_loop_question_method_iterable_bindings() {
