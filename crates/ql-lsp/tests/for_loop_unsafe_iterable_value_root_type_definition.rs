...
"#,
    ...
    if broken {
        ...
        .expect("dependency unsafe iterable value root type definition should exist");
...
#[test]
fn type_definition_bridge_follows_dependency_unsafe_tuple_for_loop_value_roots() {
    run_type_definition_case(BindingKind::UnsafeTuple, false);
}

#[test]
fn type_definition_bridge_follows_dependency_unsafe_array_for_loop_value_roots() {
    run_type_definition_case(BindingKind::UnsafeArray, false);
}

#[test]
fn type_definition_fallback_follows_dependency_unsafe_tuple_for_loop_value_roots() {
    run_type_definition_case(BindingKind::UnsafeTuple, true);
}

#[test]
fn type_definition_fallback_follows_dependency_unsafe_array_for_loop_value_roots() {
    run_type_definition_case(BindingKind::UnsafeArray, true);
}
