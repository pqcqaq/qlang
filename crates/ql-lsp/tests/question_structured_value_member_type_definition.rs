...
fn run_type_definition_case(
    ...
    let temp = TempDir::new(&format!(
        "ql-lsp-question-{}-{}-{}-member-type-definition{}",
        root.label(),
        structured.label(),
        member.label(),
...
"#,
    ...
    if broken {
        ...
        .expect("structured question member type definition should exist");
...
#[test]
fn type_definition_bridge_follows_if_question_function_value_field_member_types() {
...
#[test]
fn type_definition_fallback_follows_if_question_function_value_field_member_types() {
    run_type_definition_case(
        RootKind::Function,
        MemberKind::Field,
        StructuredKind::If,
...
#[test]
fn type_definition_bridge_follows_if_question_function_value_method_member_types() {
    run_type_definition_case(
        RootKind::Function,
        MemberKind::Method,
        StructuredKind::If,
...
#[test]
fn type_definition_fallback_follows_if_question_function_value_method_member_types() {
    run_type_definition_case(
        RootKind::Function,
        MemberKind::Method,
        StructuredKind::If,
...
#[test]
fn type_definition_bridge_follows_match_question_function_value_field_member_types() {
    run_type_definition_case(
        RootKind::Function,
        MemberKind::Field,
...
#[test]
fn type_definition_fallback_follows_match_question_function_value_field_member_types() {
    run_type_definition_case(
        RootKind::Function,
        MemberKind::Field,
        StructuredKind::Match,
...
#[test]
fn type_definition_bridge_follows_match_question_function_value_method_member_types() {
    run_type_definition_case(
        RootKind::Function,
        MemberKind::Method,
        StructuredKind::Match,
...
#[test]
fn type_definition_fallback_follows_match_question_function_value_method_member_types() {
    run_type_definition_case(
        RootKind::Function,
        MemberKind::Method,
        StructuredKind::Match,
...
#[test]
fn type_definition_bridge_follows_if_question_static_value_field_member_types() {
    run_type_definition_case(
        RootKind::Static,
        MemberKind::Field,
        StructuredKind::If,
...
#[test]
fn type_definition_fallback_follows_if_question_static_value_field_member_types() {
    run_type_definition_case(
        RootKind::Static,
        MemberKind::Field,
        StructuredKind::If,
...
#[test]
fn type_definition_bridge_follows_if_question_static_value_method_member_types() {
    run_type_definition_case(
        RootKind::Static,
        MemberKind::Method,
        StructuredKind::If,
...
#[test]
fn type_definition_fallback_follows_if_question_static_value_method_member_types() {
    run_type_definition_case(
        RootKind::Static,
        MemberKind::Method,
        StructuredKind::If,
...
#[test]
fn type_definition_bridge_follows_match_question_static_value_field_member_types() {
    run_type_definition_case(
        RootKind::Static,
        MemberKind::Field,
        StructuredKind::Match,
...
#[test]
fn type_definition_fallback_follows_match_question_static_value_field_member_types() {
    run_type_definition_case(
        RootKind::Static,
        MemberKind::Field,
        StructuredKind::Match,
...
#[test]
fn type_definition_bridge_follows_match_question_static_value_method_member_types() {
    run_type_definition_case(
        RootKind::Static,
        MemberKind::Method,
        StructuredKind::Match,
...
#[test]
fn type_definition_fallback_follows_match_question_static_value_method_member_types() {
    run_type_definition_case(
        RootKind::Static,
        MemberKind::Method,
        StructuredKind::Match,
