...
fn run_type_definition_case(root: RootKind, member: MemberKind, broken: bool) {
...
"#,
    ...
    if broken {
        ...
        .expect("grouped question member type definition should exist");
...
#[test]
fn type_definition_bridge_follows_grouped_question_function_value_field_member_types() {
    run_type_definition_case(RootKind::Function, MemberKind::Field, false);
}

#[test]
fn type_definition_fallback_follows_grouped_question_function_value_field_member_types() {
    run_type_definition_case(RootKind::Function, MemberKind::Field, true);
}

#[test]
fn type_definition_bridge_follows_grouped_question_function_value_method_member_types() {
    run_type_definition_case(RootKind::Function, MemberKind::Method, false);
}

#[test]
fn type_definition_fallback_follows_grouped_question_function_value_method_member_types() {
    run_type_definition_case(RootKind::Function, MemberKind::Method, true);
}

#[test]
fn type_definition_bridge_follows_grouped_question_static_value_field_member_types() {
    run_type_definition_case(RootKind::Static, MemberKind::Field, false);
}

#[test]
fn type_definition_fallback_follows_grouped_question_static_value_field_member_types() {
    run_type_definition_case(RootKind::Static, MemberKind::Field, true);
}

#[test]
fn type_definition_bridge_follows_grouped_question_static_value_method_member_types() {
    run_type_definition_case(RootKind::Static, MemberKind::Method, false);
}

#[test]
fn type_definition_fallback_follows_grouped_question_static_value_method_member_types() {
    run_type_definition_case(RootKind::Static, MemberKind::Method, true);
}
