...
#[test]
fn root_query_bridge_surfaces_dependency_for_loop_field_array_bindings() {
    run_root_query_case(BindingKind::FieldArray);
}

#[test]
fn root_query_bridge_surfaces_dependency_for_loop_field_tuple_bindings() {
    run_root_query_case(BindingKind::FieldTuple);
}
