...
"#,
    ...
    if broken {
        ...
        .expect("dependency field-iterable value root hover should exist");
        ...
        .expect("dependency field-iterable value root definition should exist");
        ...
        .expect("dependency field-iterable value root declaration should exist");
        ...
        .expect("dependency field-iterable value root references should exist");
        assert_eq!(
            without_declaration,
            vec![
                Location::new(
        ...
        .expect("dependency field-iterable value root references with declaration should exist");
...
#[test]
fn root_query_bridge_surfaces_dependency_for_loop_field_array_value_roots() {
    run_root_query_case(BindingKind::FieldArray, false);
}

#[test]
fn root_query_bridge_surfaces_dependency_for_loop_field_tuple_value_roots() {
    run_root_query_case(BindingKind::FieldTuple, false);
}

#[test]
fn root_query_fallback_surfaces_dependency_for_loop_field_array_value_roots() {
    run_root_query_case(BindingKind::FieldArray, true);
}

#[test]
fn root_query_fallback_surfaces_dependency_for_loop_field_tuple_value_roots() {
    run_root_query_case(BindingKind::FieldTuple, true);
}
