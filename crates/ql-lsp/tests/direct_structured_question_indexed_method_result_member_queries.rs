...
fn run_query_case(structured: StructuredKind, broken: bool) {
    let temp = TempDir::new(&format!(
        "ql-lsp-direct-structured-question-indexed-{}-method-result-member-query{}",
        structured.label(),
...
"#,
    ...
    if broken {
        ...
        .expect("direct structured question indexed method-result member hover should exist");
        ...
        .expect("direct structured question indexed method-result member definition should exist");
        ...
        .expect("direct structured question indexed method-result member declaration should exist");
        ...
        .expect("direct structured question indexed method-result member references should exist");
        ...
        .expect(
            "direct structured question indexed method-result member references without declaration should exist",
        );
...
#[test]
fn queries_work_on_if_direct_structured_question_indexed_method_result_members() {
    run_query_case(StructuredKind::If, false);
}

#[test]
fn queries_work_on_match_direct_structured_question_indexed_method_result_members() {
    run_query_case(StructuredKind::Match, false);
}

#[test]
fn queries_fallback_on_if_direct_structured_question_indexed_method_result_members() {
    run_query_case(StructuredKind::If, true);
}

#[test]
fn queries_fallback_on_match_direct_structured_question_indexed_method_result_members() {
