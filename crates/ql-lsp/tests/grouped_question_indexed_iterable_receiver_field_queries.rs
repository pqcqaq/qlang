...
fn run_query_case(broken: bool) {
    let temp = TempDir::new(&format!(
        "ql-lsp-grouped-question-indexed-receiver-field-query{}",
...
"#,
    ...
    if broken {
        ...
        .expect("grouped question indexed iterable receiver field hover should exist");
        ...
        .expect("grouped question indexed iterable receiver field definition should exist");
        ...
        .expect("grouped question indexed iterable receiver field declaration should exist");
        ...
        .expect("grouped question indexed iterable receiver field references should exist");
        ...
        .expect(
            "grouped question indexed iterable receiver field references without declaration should exist",
        );
...
#[test]
fn queries_work_on_grouped_question_indexed_iterable_receiver_fields() {
    run_query_case(false);
}

#[test]
fn queries_fallback_on_grouped_question_indexed_iterable_receiver_fields() {
    run_query_case(true);
}
