...
#[test]
fn type_definition_bridge_follows_dependency_member_field_types() {
    let temp = TempDir::new("ql-lsp-field-type-definition");
...
#[test]
fn type_definition_bridge_follows_dependency_member_field_types_without_semantic_analysis() {
    let temp = TempDir::new("ql-lsp-field-type-definition-broken");
    let app_root = temp.path().join("workspace").join("app");
