...
#[test]
fn dependency_field_completion_works_on_question_unwrapped_local_field_receivers_without_semantic_analysis()
 {
    let temp = TempDir::new("ql-lsp-question-unwrapped-local-value-completion-broken");
