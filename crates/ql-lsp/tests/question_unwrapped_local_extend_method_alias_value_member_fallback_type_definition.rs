...
#[test]
fn type_definition_fallback_follows_question_unwrapped_local_extend_method_alias_field_member_types(
) {
    let temp = TempDir::new(
        "ql-lsp-question-unwrapped-local-extend-method-alias-value-member-type-definition-broken",
    );
...
"#;
    ...
    .expect(
        "dependency extend-method-result alias local field member type definition should exist without semantic analysis",
    );
