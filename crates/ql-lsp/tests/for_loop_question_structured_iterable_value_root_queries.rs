...
fn run_root_query_case(binding: BindingKind, broken: bool) {
    let temp = TempDir::new(&format!(
        "ql-lsp-for-loop-question-structured-iterable-{}-value-root-query{}",
        binding.label(),
...
"#,
    ...
    if broken {
        ...
        .expect("structured dependency question iterable value root hover should exist");
        ...
        .expect("structured dependency question iterable value root definition should exist");
        ...
        .expect("structured dependency question iterable value root declaration should exist");
        ...
        .expect("structured dependency question iterable value root references should exist");
        assert_eq!(
            without_declaration,
            vec![
                Location::new(
        ...
        .expect(
            "structured dependency question iterable value root references with declaration should exist",
        );
...
#[test]
fn root_query_bridge_surfaces_dependency_for_loop_if_question_structured_field_bindings() {
    run_root_query_case(BindingKind::Field, false);
}

#[test]
fn root_query_bridge_surfaces_dependency_for_loop_match_question_structured_method_bindings() {
    run_root_query_case(BindingKind::Method, false);
}

#[test]
fn root_query_fallback_surfaces_dependency_for_loop_if_question_structured_field_bindings() {
    run_root_query_case(BindingKind::Field, true);
}

#[test]
fn root_query_fallback_surfaces_dependency_for_loop_match_question_structured_method_bindings() {
    run_root_query_case(BindingKind::Method, true);
}
