...
impl BindingKind {
    fn label(self) -> &'static str {
        match self {
            Self::UnsafeTuple => "unsafe-tuple",
            Self::UnsafeArray => "unsafe-array",
        }
    }

    fn dep_struct_name(self) -> &'static str {
        match self {
            Self::UnsafeTuple => "Config",
            Self::UnsafeArray => "Child",
        }
    }

    fn dep_struct_snippet(self) -> &'static str {
        match self {
            Self::UnsafeTuple => "pub struct Config {\n    value: Int,\n}",
            Self::UnsafeArray => "pub struct Child {\n    value: Int,\n}",
        }
    }
...
#[test]
fn root_query_bridge_surfaces_dependency_unsafe_tuple_for_loop_value_roots() {
    run_root_query_case(BindingKind::UnsafeTuple, false);
}

#[test]
fn root_query_bridge_surfaces_dependency_unsafe_array_for_loop_value_roots() {
    run_root_query_case(BindingKind::UnsafeArray, false);
}

#[test]
fn root_query_fallback_surfaces_dependency_unsafe_tuple_for_loop_value_roots() {
    run_root_query_case(BindingKind::UnsafeTuple, true);
}

#[test]
fn root_query_fallback_surfaces_dependency_unsafe_array_for_loop_value_roots() {
    run_root_query_case(BindingKind::UnsafeArray, true);
}
