...
#[test]
fn root_query_bridge_surfaces_dependency_unsafe_tuple_for_loop_bindings() {
    run_root_query_case(BindingKind::UnsafeTuple);
}

#[test]
fn root_query_bridge_surfaces_dependency_unsafe_array_for_loop_bindings() {
    run_root_query_case(BindingKind::UnsafeArray);
}
