...
"#,
    ...
    if broken {
        ...
        let Some(CompletionResponse::Array(items)) =
            ...
            panic!("grouped structured question member completion should exist");
        };
        assert_eq!(items.len(), 1);
        assert_completion_item(member, items[0].clone());
    }
...
#[test]
fn dependency_field_completion_works_on_if_grouped_question_function_value_receivers() {
    run_completion_case(
        RootKind::Function,
        MemberKind::Field,
        StructuredKind::If,
...
#[test]
fn dependency_method_completion_works_on_if_grouped_question_function_value_receivers() {
    run_completion_case(
        RootKind::Function,
        MemberKind::Method,
        StructuredKind::If,
...
#[test]
fn dependency_field_completion_works_on_match_grouped_question_function_value_receivers() {
    run_completion_case(
        RootKind::Function,
        MemberKind::Field,
...
#[test]
fn dependency_method_completion_works_on_match_grouped_question_function_value_receivers() {
    run_completion_case(
        RootKind::Function,
        MemberKind::Method,
        StructuredKind::Match,
...
#[test]
fn dependency_field_completion_works_on_if_grouped_question_static_value_receivers() {
    run_completion_case(
        RootKind::Static,
        MemberKind::Field,
        StructuredKind::If,
...
#[test]
fn dependency_method_completion_works_on_if_grouped_question_static_value_receivers() {
    run_completion_case(
        RootKind::Static,
        MemberKind::Method,
        StructuredKind::If,
...
#[test]
fn dependency_field_completion_works_on_match_grouped_question_static_value_receivers() {
    run_completion_case(
        RootKind::Static,
        MemberKind::Field,
        StructuredKind::Match,
...
#[test]
fn dependency_method_completion_works_on_match_grouped_question_static_value_receivers() {
    run_completion_case(
        RootKind::Static,
        MemberKind::Method,
        StructuredKind::Match,
