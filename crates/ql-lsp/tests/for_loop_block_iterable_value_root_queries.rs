...
#[test]
fn root_query_bridge_surfaces_dependency_block_tuple_for_loop_bindings() {
    run_root_query_case(BindingKind::BlockTuple);
}

#[test]
fn root_query_bridge_surfaces_dependency_block_array_for_loop_bindings() {
    run_root_query_case(BindingKind::BlockArray);
}
