...
impl BindingKind {
    fn label(self) -> &'static str {
        match self {
            Self::BlockTuple => "block-tuple",
            Self::BlockArray => "block-array",
        }
    }

    fn dep_struct_name(self) -> &'static str {
        match self {
            Self::BlockTuple => "Config",
            Self::BlockArray => "Child",
        }
    }

    fn dep_struct_snippet(self) -> &'static str {
        match self {
            Self::BlockTuple => "pub struct Config {\n    value: Int,\n}",
            Self::BlockArray => "pub struct Child {\n    value: Int,\n}",
        }
    }
...
#[test]
fn root_query_bridge_surfaces_dependency_block_tuple_for_loop_value_roots() {
    run_root_query_case(BindingKind::BlockTuple, false);
}

#[test]
fn root_query_bridge_surfaces_dependency_block_array_for_loop_value_roots() {
    run_root_query_case(BindingKind::BlockArray, false);
}

#[test]
fn root_query_fallback_surfaces_dependency_block_tuple_for_loop_value_roots() {
    run_root_query_case(BindingKind::BlockTuple, true);
}

#[test]
fn root_query_fallback_surfaces_dependency_block_array_for_loop_value_roots() {
    run_root_query_case(BindingKind::BlockArray, true);
}
