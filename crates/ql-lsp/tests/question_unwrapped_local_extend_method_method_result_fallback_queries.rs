...
#[test]
fn dependency_field_queries_work_on_question_unwrapped_local_extend_method_result_method_result_members_without_semantic_analysis(
) {
    let temp = TempDir::new(
        "ql-lsp-question-unwrapped-local-extend-method-method-result-query-broken",
    );
...
pub fn read(config: Cfg) -> Int {
    ...
    let broken: Int = "oops"
    return current.get().value + current.get().value
}
"#;
    ...
    .expect(
        "dependency extend-method-result local method-result member hover should exist without semantic analysis",
    );
    ...
    .expect(
        "dependency extend-method-result local method-result member definition should exist without semantic analysis",
    );
    ...
    .expect(
        "dependency extend-method-result local method-result member declaration should exist without semantic analysis",
    );
    ...
    .expect(
        "dependency extend-method-result local method-result member references should exist without semantic analysis",
    );
    ...
    .expect(
        "dependency extend-method-result local method-result member references should exist without declaration",
    );
