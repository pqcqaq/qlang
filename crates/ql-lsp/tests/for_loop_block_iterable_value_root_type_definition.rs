...
"#,
    ...
    if broken {
        ...
        .expect("dependency block iterable value root type definition should exist");
...
#[test]
fn type_definition_bridge_follows_dependency_block_tuple_for_loop_value_roots() {
    run_type_definition_case(BindingKind::BlockTuple, false);
}

#[test]
fn type_definition_bridge_follows_dependency_block_array_for_loop_value_roots() {
    run_type_definition_case(BindingKind::BlockArray, false);
}

#[test]
fn type_definition_fallback_follows_dependency_block_tuple_for_loop_value_roots() {
    run_type_definition_case(BindingKind::BlockTuple, true);
}

#[test]
fn type_definition_fallback_follows_dependency_block_array_for_loop_value_roots() {
    run_type_definition_case(BindingKind::BlockArray, true);
}
