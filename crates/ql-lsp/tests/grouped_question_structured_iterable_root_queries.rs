...
fn assert_root_queries(
    ...
    if broken {
        ...
        let hover = hover_for_dependency_values(source, &package, root_position)
            .expect("grouped structured dependency question iterable root hover should exist");
        ...
        let with_declaration =
            references_for_dependency_values(uri, source, &package, root_position, true)
                .expect(
                    "grouped structured dependency question iterable root references with declaration should exist",
                );
...
#[test]
fn root_queries_work_on_if_grouped_question_function_iterable_roots() {
    run_root_query_case(RootKind::Function, StructuredKind::If, false);
}

#[test]
fn root_queries_work_on_if_grouped_question_function_iterable_roots_without_semantic_analysis() {
    run_root_query_case(RootKind::Function, StructuredKind::If, true);
}

#[test]
fn root_queries_work_on_match_grouped_question_function_iterable_roots() {
...
#[test]
fn root_queries_work_on_if_grouped_question_static_iterable_roots() {
    run_root_query_case(RootKind::Static, StructuredKind::If, false);
}

#[test]
fn root_queries_work_on_if_grouped_question_static_iterable_roots_without_semantic_analysis() {
    run_root_query_case(RootKind::Static, StructuredKind::If, true);
}

#[test]
fn root_queries_work_on_match_grouped_question_static_iterable_roots() {
