...
#[test]
fn dependency_field_completion_works_on_unsafe_tuple_for_loop_receivers() {
    run_completion_case(CaseKind::UnsafeTupleField, false);
}
...
#[test]
fn dependency_method_completion_works_on_unsafe_array_for_loop_receivers() {
    run_completion_case(CaseKind::UnsafeArrayMethod, false);
}

#[test]
fn dependency_method_completion_works_on_unsafe_array_for_loop_receivers_without_semantic_analysis()
{
    run_completion_case(CaseKind::UnsafeArrayMethod, true);
}
