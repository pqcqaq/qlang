...
#[test]
fn type_definition_bridge_follows_if_grouped_question_function_iterable_roots() {
    run_type_definition_case(RootKind::Function, StructuredKind::If, false);
}

#[test]
fn type_definition_fallback_follows_if_grouped_question_function_iterable_roots() {
    run_type_definition_case(RootKind::Function, StructuredKind::If, true);
}

#[test]
fn type_definition_bridge_follows_match_grouped_question_function_iterable_roots() {
    run_type_definition_case(RootKind::Function, StructuredKind::Match, false);
}

#[test]
fn type_definition_fallback_follows_match_grouped_question_function_iterable_roots() {
    run_type_definition_case(RootKind::Function, StructuredKind::Match, true);
}

#[test]
fn type_definition_bridge_follows_if_grouped_question_static_iterable_roots() {
    run_type_definition_case(RootKind::Static, StructuredKind::If, false);
}

#[test]
fn type_definition_fallback_follows_if_grouped_question_static_iterable_roots() {
    run_type_definition_case(RootKind::Static, StructuredKind::If, true);
}

#[test]
fn type_definition_bridge_follows_match_grouped_question_static_iterable_roots() {
    run_type_definition_case(RootKind::Static, StructuredKind::Match, false);
}

#[test]
fn type_definition_fallback_follows_match_grouped_question_static_iterable_roots() {
