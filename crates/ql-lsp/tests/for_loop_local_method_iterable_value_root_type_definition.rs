...
#[test]
fn type_definition_bridge_follows_dependency_for_loop_config_children_local_method_bindings() {
    run_type_definition_case(BindingKind::ConfigChildren);
}

#[test]
fn type_definition_bridge_follows_dependency_for_loop_self_pair_local_method_bindings() {
    run_type_definition_case(BindingKind::SelfPair);
}
