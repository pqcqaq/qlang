...
fn run_type_definition_case(root: RootKind, structured: StructuredKind, broken: bool) {
    let temp = TempDir::new(&format!(
        "ql-lsp-grouped-question-{}-{}-root-type-definition{}",
        root.label(),
        structured.label(),
...
"#,
    ...
    if broken {
        ...
        let definition = type_definition_for_dependency_values(&source, &package, position)
            .expect("grouped structured dependency question root type definition should exist");
...
#[test]
fn type_definition_bridge_follows_if_grouped_question_function_value_roots() {
    run_type_definition_case(RootKind::Function, StructuredKind::If, false);
}

#[test]
fn type_definition_fallback_follows_if_grouped_question_function_value_roots() {
    run_type_definition_case(RootKind::Function, StructuredKind::If, true);
}

#[test]
fn type_definition_bridge_follows_match_grouped_question_function_value_roots() {
    run_type_definition_case(RootKind::Function, StructuredKind::Match, false);
}

#[test]
fn type_definition_fallback_follows_match_grouped_question_function_value_roots() {
    run_type_definition_case(RootKind::Function, StructuredKind::Match, true);
}

#[test]
fn type_definition_bridge_follows_if_grouped_question_static_value_roots() {
    run_type_definition_case(RootKind::Static, StructuredKind::If, false);
}

#[test]
fn type_definition_fallback_follows_if_grouped_question_static_value_roots() {
    run_type_definition_case(RootKind::Static, StructuredKind::If, true);
}

#[test]
fn type_definition_bridge_follows_match_grouped_question_static_value_roots() {
    run_type_definition_case(RootKind::Static, StructuredKind::Match, false);
}

#[test]
fn type_definition_fallback_follows_match_grouped_question_static_value_roots() {
