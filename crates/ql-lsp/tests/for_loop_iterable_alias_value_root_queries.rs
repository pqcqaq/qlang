...
#[test]
fn root_query_bridge_surfaces_dependency_for_loop_named_tuple_alias_bindings() {
    run_root_query_case(BindingKind::TupleAlias);
}

#[test]
fn root_query_bridge_surfaces_dependency_for_loop_named_array_alias_bindings() {
    run_root_query_case(BindingKind::ArrayAlias);
}
