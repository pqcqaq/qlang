...
#[test]
fn dependency_method_completion_works_on_question_unwrapped_local_method_receivers() {
    let temp = TempDir::new("ql-lsp-question-unwrapped-local-method-completion");
