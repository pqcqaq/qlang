...
fn run_query_case(broken: bool) {
    let temp = TempDir::new(&format!(
        "ql-lsp-grouped-question-indexed-iterable-method-result-member-query{}",
...
"#,
    ...
    if broken {
        ...
        .expect(
            "grouped question indexed iterable method-result member hover should exist without semantic analysis",
        );
...
#[test]
fn queries_work_on_grouped_question_indexed_iterable_method_result_members() {
    run_query_case(false);
}

#[test]
fn queries_fallback_on_grouped_question_indexed_iterable_method_result_members() {
    run_query_case(true);
}
