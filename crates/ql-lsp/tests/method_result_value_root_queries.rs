...
fn run_root_query_case(broken: bool) {
    let temp = TempDir::new(&format!(
        "ql-lsp-method-result-value-root-query{}",
...
#[test]
fn root_query_bridge_surfaces_dependency_method_result_locals() {
    run_root_query_case(false);
}

#[test]
fn root_query_fallback_surfaces_dependency_method_result_locals() {
