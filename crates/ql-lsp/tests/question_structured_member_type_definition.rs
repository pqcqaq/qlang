...
"#,
    ...
    if broken {
        ...
        .expect("structured question-unwrapped member type definition should exist");
...
#[test]
fn type_definition_bridge_follows_if_structured_question_unwrapped_dependency_field_member_types() {
    run_type_definition_case(MemberKind::Field, StructuredKind::If, false);
}

#[test]
fn type_definition_fallback_follows_if_structured_question_unwrapped_dependency_field_member_types()
{
...
#[test]
fn type_definition_bridge_follows_if_structured_question_unwrapped_dependency_method_member_types()
{
