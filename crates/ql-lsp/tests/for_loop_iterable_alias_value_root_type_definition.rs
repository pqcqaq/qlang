...
fn run_type_definition_case(binding: BindingKind, broken: bool) {
    let temp = TempDir::new(&format!(
        "ql-lsp-for-loop-iterable-alias-{}-value-root-type-definition{}",
        binding.label(),
...
"#,
    ...
    if broken {
        ...
        .expect("dependency iterable alias value root type definition should exist");
...
#[test]
fn type_definition_bridge_follows_dependency_for_loop_named_tuple_alias_value_roots() {
    run_type_definition_case(BindingKind::TupleAlias, false);
}

#[test]
fn type_definition_bridge_follows_dependency_for_loop_named_array_alias_value_roots() {
    run_type_definition_case(BindingKind::ArrayAlias, false);
}

#[test]
fn type_definition_fallback_follows_dependency_for_loop_named_tuple_alias_value_roots() {
    run_type_definition_case(BindingKind::TupleAlias, true);
}

#[test]
fn type_definition_fallback_follows_dependency_for_loop_named_array_alias_value_roots() {
    run_type_definition_case(BindingKind::ArrayAlias, true);
}
