...
#[test]
fn type_definition_bridge_follows_dependency_for_loop_named_tuple_alias_bindings() {
    run_type_definition_case(BindingKind::TupleAlias);
}

#[test]
fn type_definition_bridge_follows_dependency_for_loop_named_array_alias_bindings() {
    run_type_definition_case(BindingKind::ArrayAlias);
}
