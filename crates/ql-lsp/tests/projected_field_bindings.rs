...
#[test]
fn dependency_field_definition_works_on_direct_dependency_field_projection_receiver() {
    let temp = TempDir::new("ql-lsp-projected-field-direct");
...
#[test]
fn dependency_method_definition_works_on_direct_dependency_field_projection_receiver_without_semantic_analysis()
 {
    let temp = TempDir::new("ql-lsp-projected-field-method-broken");
    let app_root = temp.path().join("workspace").join("app");
...
#[test]
fn dependency_field_definition_works_on_local_bound_from_dependency_field_projection() {
    let temp = TempDir::new("ql-lsp-projected-field-local");
    let app_root = temp.path().join("workspace").join("app");
