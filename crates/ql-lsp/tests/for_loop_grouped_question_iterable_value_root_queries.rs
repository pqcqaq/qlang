...
fn run_root_query_case(root: RootKind) {
...
"#,
    ...
    .expect("grouped dependency question iterable value root references with declaration should exist");
