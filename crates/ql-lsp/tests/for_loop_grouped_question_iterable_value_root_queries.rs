...
fn run_root_query_case(root: RootKind, broken: bool) {
    let temp = TempDir::new(&format!(
        "ql-lsp-for-loop-grouped-question-iterable-{}-value-root-query{}",
        root.label(),
...
"#,
    ...
    if broken {
        ...
        .expect("grouped dependency question iterable value root hover should exist");
        ...
        .expect("grouped dependency question iterable value root definition should exist");
        ...
        .expect("grouped dependency question iterable value root declaration should exist");
        ...
        .expect("grouped dependency question iterable value root references should exist");
        assert_eq!(
            without_declaration,
            vec![
                Location::new(
        ...
        .expect(
            "grouped dependency question iterable value root references with declaration should exist",
        );
...
#[test]
fn root_query_bridge_surfaces_dependency_for_loop_grouped_question_function_bindings() {
    run_root_query_case(RootKind::Function, false);
}

#[test]
fn root_query_bridge_surfaces_dependency_for_loop_grouped_question_static_bindings() {
    run_root_query_case(RootKind::Static, false);
}

#[test]
fn root_query_fallback_surfaces_dependency_for_loop_grouped_question_function_bindings() {
    run_root_query_case(RootKind::Function, true);
}

#[test]
fn root_query_fallback_surfaces_dependency_for_loop_grouped_question_static_bindings() {
