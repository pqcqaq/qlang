...
fn run_type_definition_case(broken: bool) {
    let temp = TempDir::new(&format!(
        "ql-lsp-projected-field-alias-value-root-type-definition{}",
...
"#,
    ...
    if broken {
        ...
        .expect("dependency projected field alias value root type definition should exist");
...
#[test]
fn type_definition_bridge_follows_dependency_projected_field_alias_value_roots() {
    run_type_definition_case(false);
}

#[test]
fn type_definition_fallback_follows_dependency_projected_field_alias_value_roots() {
