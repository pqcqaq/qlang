...
fn run_type_definition_case(broken: bool) {
    let temp = TempDir::new(&format!(
        "ql-lsp-question-unwrapped-local-value-root-type-definition{}",
...
#[test]
fn type_definition_bridge_follows_dependency_question_unwrapped_local_roots() {
    run_type_definition_case(false);
}

#[test]
fn type_definition_fallback_follows_dependency_question_unwrapped_local_roots() {
