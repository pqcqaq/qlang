...
#[test]
fn dependency_field_definition_works_on_imported_dependency_function_result_and_static_receivers() {
    let temp = TempDir::new("ql-lsp-dependency-root-field-binding");
...
use demo.dep.load
use demo.dep.CURRENT as current
...
"#;
    ...
    .expect("dependency function-result field definition should exist");
...
"#;
    ...
    .expect("dependency function-result method definition should exist");
    ...
    .expect("dependency static method definition should exist");
