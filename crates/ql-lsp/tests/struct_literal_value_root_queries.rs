...
"#,
    ...
    if broken {
        ...
        .expect("dependency struct literal value root hover should exist");
        ...
        .expect("dependency struct literal value root definition should exist");
        ...
        .expect("dependency struct literal value root declaration should exist");
        ...
        .expect("dependency struct literal value root references should exist");
        assert_eq!(
            without_declaration,
            vec![
                Location::new(
        ...
        .expect("dependency struct literal value root references with declaration should exist");
