...
fn run_query_case(broken: bool) {
    let temp = TempDir::new(&format!(
        "ql-lsp-grouped-question-indexed-receiver-method-query{}",
...
"#,
    ...
    if broken {
        ...
        .expect("grouped question indexed iterable receiver method hover should exist");
        ...
        .expect("grouped question indexed iterable receiver method definition should exist");
        ...
        .expect("grouped question indexed iterable receiver method declaration should exist");
        ...
        .expect("grouped question indexed iterable receiver method references should exist");
        ...
        .expect(
            "grouped question indexed iterable receiver method references without declaration should exist",
        );
...
#[test]
fn queries_work_on_grouped_question_indexed_iterable_receiver_methods() {
    run_query_case(false);
}

#[test]
fn queries_fallback_on_grouped_question_indexed_iterable_receiver_methods() {
    run_query_case(true);
}
