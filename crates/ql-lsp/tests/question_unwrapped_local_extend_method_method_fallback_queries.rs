...
#[test]
fn dependency_method_queries_work_on_question_unwrapped_local_extend_method_result_receivers_without_semantic_analysis(
) {
    let temp = TempDir::new(
        "ql-lsp-question-unwrapped-local-extend-method-method-query-broken",
    );
...
"#;
    ...
    let hover =
        hover_for_dependency_methods(source, &package, offset_to_position(source, first_offset))
            .expect(
                "dependency extend-method-result local method hover should exist without semantic analysis",
            );
    ...
    .expect(
        "dependency extend-method-result local method definition should exist without semantic analysis",
    );
    ...
    .expect(
        "dependency extend-method-result local method declaration should exist without semantic analysis",
    );
    ...
    .expect(
        "dependency extend-method-result local method references should exist without semantic analysis",
    );
    ...
    .expect(
        "dependency extend-method-result local method references should exist without declaration",
    );
