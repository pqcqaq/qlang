...
#[test]
fn dependency_field_definition_works_on_for_loop_named_tuple_alias_receivers() {
    let temp = TempDir::new("ql-lsp-for-loop-alias-field");
...
"#,
    ...
    .expect("dependency iterable alias field definition should exist");
