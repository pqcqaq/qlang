...
fn run_completion_case(broken: bool) {
    let temp = TempDir::new(&format!(
        "ql-lsp-direct-indexed-question-iterable-receiver-field-completion{}",
...
"#,
    ...
    let items = if broken {
        ...
        let Some(CompletionResponse::Array(items)) =
            ...
            panic!(
                "direct indexed question iterable receiver-field completion should exist without semantic analysis"
            );
        };
        items
    } else {
        ...
        let Some(CompletionResponse::Array(items)) =
            ...
            panic!("direct indexed question iterable receiver-field completion should exist");
        };
        items
    };
...
#[test]
fn completion_works_on_direct_indexed_question_iterable_receiver_fields() {
    run_completion_case(false);
}

#[test]
fn completion_fallback_works_on_direct_indexed_question_iterable_receiver_fields() {
