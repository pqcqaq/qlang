...
fn run_member_query_case(root: RootKind, member: MemberKind, broken: bool) {
    let temp = TempDir::new(&format!(
        "ql-lsp-grouped-question-{}-{}-member-query{}",
        root.label(),
        member.label(),
...
#[test]
fn dependency_field_queries_work_on_grouped_question_function_value_receivers() {
...
#[test]
fn dependency_method_queries_work_on_grouped_question_function_value_receivers() {
...
#[test]
fn dependency_field_queries_work_on_grouped_question_static_value_receivers() {
...
#[test]
fn dependency_method_queries_work_on_grouped_question_static_value_receivers() {
