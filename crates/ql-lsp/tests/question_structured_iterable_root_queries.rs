...
fn assert_root_queries(
    ...
    if broken {
        ...
        let hover = hover_for_dependency_values(source, &package, root_position)
            .expect("structured dependency question iterable root hover should exist");
        ...
        let definition = definition_for_dependency_values(source, &package, root_position)
            .expect("structured dependency question iterable root definition should exist");
        ...
        let declaration = declaration_for_dependency_values(source, &package, root_position)
            .expect("structured dependency question iterable root declaration should exist");
        ...
        let without_declaration =
            references_for_dependency_values(uri, source, &package, root_position, false)
                .expect("structured dependency question iterable root references should exist");
        assert_eq!(
            without_declaration,
            vec![
                Location::new(
        ...
        .expect(
            "structured dependency question iterable root references with declaration should exist",
        );
...
fn run_root_query_case(root: RootKind, structured: StructuredKind, broken: bool) {
    let temp = TempDir::new(&format!(
        "ql-lsp-question-iterable-{}-{}-root-query{}",
        root.label(),
        structured.label(),
...
#[test]
fn root_queries_work_on_if_question_function_iterable_roots() {
    run_root_query_case(RootKind::Function, StructuredKind::If, false);
}

#[test]
fn root_queries_work_on_if_question_function_iterable_roots_without_semantic_analysis() {
    run_root_query_case(RootKind::Function, StructuredKind::If, true);
}

#[test]
fn root_queries_work_on_match_question_function_iterable_roots() {
    run_root_query_case(RootKind::Function, StructuredKind::Match, false);
}

#[test]
fn root_queries_work_on_match_question_function_iterable_roots_without_semantic_analysis() {
    run_root_query_case(RootKind::Function, StructuredKind::Match, true);
}

#[test]
fn root_queries_work_on_if_question_static_iterable_roots() {
    run_root_query_case(RootKind::Static, StructuredKind::If, false);
}

#[test]
fn root_queries_work_on_if_question_static_iterable_roots_without_semantic_analysis() {
    run_root_query_case(RootKind::Static, StructuredKind::If, true);
}

#[test]
fn root_queries_work_on_match_question_static_iterable_roots() {
    run_root_query_case(RootKind::Static, StructuredKind::Match, false);
}

#[test]
fn root_queries_work_on_match_question_static_iterable_roots_without_semantic_analysis() {
