...
#[test]
fn dependency_field_definition_works_on_dependency_self_receiver() {
    let temp = TempDir::new("ql-lsp-self-field");
...
#[test]
fn dependency_method_definition_works_on_dependency_self_receiver_without_semantic_analysis() {
    let temp = TempDir::new("ql-lsp-self-method-broken");
    let app_root = temp.path().join("workspace").join("app");
...
#[test]
fn type_definition_bridge_follows_dependency_self_receiver_types() {
    let temp = TempDir::new("ql-lsp-self-type-definition");
    let app_root = temp.path().join("workspace").join("app");
    let app_path = temp
        .path()
        .join("workspace")
...
"#;
    ...
    .expect("dependency self type definition should exist");
