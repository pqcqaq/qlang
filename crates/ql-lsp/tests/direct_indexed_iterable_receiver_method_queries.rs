...
fn run_query_case(broken: bool) {
    let temp = TempDir::new(&format!(
        "ql-lsp-direct-indexed-iterable-receiver-method-query{}",
...
"#,
    ...
    if broken {
        ...
        .expect("direct indexed iterable receiver method hover should exist");
        ...
        .expect("direct indexed iterable receiver method definition should exist");
        ...
        .expect("direct indexed iterable receiver method declaration should exist");
        ...
        .expect("direct indexed iterable receiver method references should exist");
        assert_eq!(with_declaration.len(), 3);
        assert_dependency_location(&with_declaration[0], &dep_qi, "pub fn get(self) -> Int", "get");
        ...
        .expect(
            "direct indexed iterable receiver method references without declaration should exist",
        );
...
#[test]
fn queries_work_on_direct_indexed_iterable_receiver_methods() {
    run_query_case(false);
}

#[test]
fn queries_fallback_on_direct_indexed_iterable_receiver_methods() {
    run_query_case(true);
}
