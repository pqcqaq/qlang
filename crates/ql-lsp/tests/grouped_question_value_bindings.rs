...
#[test]
fn dependency_field_definition_works_on_grouped_question_function_and_static_value_receivers() {
    let temp = TempDir::new("ql-lsp-grouped-question-value-field-binding");
...
"#;
    ...
    .expect("grouped question function field definition should exist");
    ...
    .expect("grouped question static field definition should exist");
...
pub fn read(flag: Bool) -> Int {
    if flag {
        let first = load_cfg()?.get()
    } else {
        let second = maybe_cfg?.get()
    }
    return "oops"
}
"#;
    ...
    .expect("grouped question function method definition should exist");
    ...
    .expect("grouped question static method definition should exist");
