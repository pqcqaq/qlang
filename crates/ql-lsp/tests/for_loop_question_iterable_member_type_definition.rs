...
fn run_type_definition_case(member: MemberKind, broken: bool) {
    let temp = TempDir::new(&format!(
        "ql-lsp-for-loop-question-iterable-{}-member-type-definition{}",
        member.label(),
...
#[test]
fn type_definition_bridge_follows_for_loop_question_iterable_field_member_types() {
    run_type_definition_case(MemberKind::Field, false);
}

#[test]
fn type_definition_fallback_follows_for_loop_question_iterable_field_member_types() {
    run_type_definition_case(MemberKind::Field, true);
}

#[test]
fn type_definition_bridge_follows_for_loop_question_iterable_method_member_types() {
    run_type_definition_case(MemberKind::Method, false);
}

#[test]
fn type_definition_fallback_follows_for_loop_question_iterable_method_member_types() {
