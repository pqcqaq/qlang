...
fn member_dependency_qi(root: RootKind, member: MemberKind) -> String {
...
"#,
    ...
    temp.write("workspace/dep/dep.qi", &member_dependency_qi(root, member));
    temp.write(
...
"#,
    ...
    if broken {
        ...
        let Some(CompletionResponse::Array(items)) =
            ...
            panic!("structured question value member completion should exist");
        };
        assert_eq!(items.len(), 1);
        assert_member_completion_item(member, &items[0]);
    }
...
#[test]
fn dependency_field_completion_works_on_if_question_function_value_receivers() {
    run_completion_case(
        RootKind::Function,
        MemberKind::Field,
        StructuredKind::If,
...
#[test]
fn dependency_method_completion_works_on_if_question_function_value_receivers() {
    run_completion_case(
        RootKind::Function,
        MemberKind::Method,
        StructuredKind::If,
...
#[test]
fn dependency_field_completion_works_on_match_question_function_value_receivers() {
    run_completion_case(
        RootKind::Function,
        MemberKind::Field,
...
#[test]
fn dependency_method_completion_works_on_match_question_function_value_receivers() {
    run_completion_case(
        RootKind::Function,
        MemberKind::Method,
        StructuredKind::Match,
...
#[test]
fn dependency_field_completion_works_on_if_question_static_value_receivers() {
    run_completion_case(
        RootKind::Static,
        MemberKind::Field,
        StructuredKind::If,
...
#[test]
fn dependency_method_completion_works_on_if_question_static_value_receivers() {
    run_completion_case(
        RootKind::Static,
        MemberKind::Method,
        StructuredKind::If,
...
#[test]
fn dependency_field_completion_works_on_match_question_static_value_receivers() {
    run_completion_case(
        RootKind::Static,
        MemberKind::Field,
        StructuredKind::Match,
...
#[test]
fn dependency_method_completion_works_on_match_question_static_value_receivers() {
    run_completion_case(
        RootKind::Static,
        MemberKind::Method,
        StructuredKind::Match,
