...
#[test]
fn type_definition_fallback_follows_question_unwrapped_local_extend_method_alias_method_member_types(
) {
    let temp = TempDir::new(
        "ql-lsp-question-unwrapped-local-extend-method-alias-method-type-definition-broken",
    );
...
"#;
    ...
    .expect(
        "dependency extend-method-result alias local method type definition should exist without semantic analysis",
    );
