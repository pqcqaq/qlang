...
#[test]
fn dependency_field_queries_work_on_if_question_function_iterable_receivers() {
...
#[test]
fn dependency_method_queries_work_on_if_question_function_iterable_receivers() {
    run_member_query_case(
        RootKind::Function,
        MemberKind::Method,
        StructuredKind::If,
...
#[test]
fn dependency_field_queries_work_on_match_question_function_iterable_receivers() {
    run_member_query_case(
        RootKind::Function,
        MemberKind::Field,
...
#[test]
fn dependency_method_queries_work_on_match_question_function_iterable_receivers() {
    run_member_query_case(
        RootKind::Function,
        MemberKind::Method,
        StructuredKind::Match,
...
#[test]
fn dependency_field_queries_work_on_if_question_static_iterable_receivers() {
    run_member_query_case(
        RootKind::Static,
        MemberKind::Field,
        StructuredKind::If,
...
#[test]
fn dependency_method_queries_work_on_if_question_static_iterable_receivers() {
    run_member_query_case(
        RootKind::Static,
        MemberKind::Method,
        StructuredKind::If,
...
#[test]
fn dependency_field_queries_work_on_match_question_static_iterable_receivers() {
    run_member_query_case(
        RootKind::Static,
        MemberKind::Field,
        StructuredKind::Match,
...
#[test]
fn dependency_method_queries_work_on_match_question_static_iterable_receivers() {
    run_member_query_case(
        RootKind::Static,
        MemberKind::Method,
        StructuredKind::Match,
