...
#[test]
fn root_query_bridge_surfaces_dependency_for_loop_helper_tuple_bindings() {
    run_root_query_case(BindingKind::HelperTuple);
}

#[test]
fn root_query_bridge_surfaces_dependency_for_loop_helper_array_bindings() {
    run_root_query_case(BindingKind::HelperArray);
}
