...
impl BindingKind {
    fn label(self) -> &'static str {
        match self {
            Self::HelperTuple => "helper-tuple",
            Self::HelperArray => "helper-array",
        }
    }

    fn dep_struct_name(self) -> &'static str {
        match self {
            Self::HelperTuple => "Config",
            Self::HelperArray => "Child",
        }
    }

    fn dep_struct_snippet(self) -> &'static str {
        match self {
            Self::HelperTuple => "pub struct Config {\n    value: Int,\n}",
            Self::HelperArray => "pub struct Child {\n    value: Int,\n}",
        }
    }
...
fn children(config: Cfg) -> [Child; 2] {{
    return [config.child(), config.child()]
}}
...
fn run_root_query_case(binding: BindingKind, broken: bool) {
    let temp = TempDir::new(&format!(
        "ql-lsp-for-loop-{}-value-root-query{}",
        binding.label(),
...
"#,
    ...
    if broken {
        ...
        .expect("dependency helper-return value root hover should exist");
        ...
        .expect("dependency helper-return value root definition should exist");
        ...
        .expect("dependency helper-return value root declaration should exist");
        ...
        .expect("dependency helper-return value root references should exist");
        assert_eq!(
            without_declaration,
            vec![
                Location::new(
        ...
        .expect("dependency helper-return value root references with declaration should exist");
...
#[test]
fn root_query_bridge_surfaces_dependency_for_loop_helper_tuple_value_roots() {
    run_root_query_case(BindingKind::HelperTuple, false);
}

#[test]
fn root_query_bridge_surfaces_dependency_for_loop_helper_array_value_roots() {
    run_root_query_case(BindingKind::HelperArray, false);
}

#[test]
fn root_query_fallback_surfaces_dependency_for_loop_helper_tuple_value_roots() {
    run_root_query_case(BindingKind::HelperTuple, true);
}

#[test]
fn root_query_fallback_surfaces_dependency_for_loop_helper_array_value_roots() {
    run_root_query_case(BindingKind::HelperArray, true);
}
