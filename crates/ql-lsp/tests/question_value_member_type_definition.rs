...
"#,
    ...
    if broken {
        ...
        .expect("question value member type definition should exist without semantic analysis");
        ...
        .expect("question value member type definition should exist");
        assert_targets_dependency_type(definition, &dep_qi, "pub struct Leaf {\n    value: Int,\n}");
    }
}

#[test]
fn type_definition_bridge_follows_question_function_field_members() {
    run_type_definition_case(RootKind::Function, MemberKind::Field, false);
}

#[test]
fn type_definition_fallback_follows_question_function_field_members() {
    run_type_definition_case(RootKind::Function, MemberKind::Field, true);
}

#[test]
fn type_definition_bridge_follows_question_function_method_members() {
    run_type_definition_case(RootKind::Function, MemberKind::Method, false);
}

#[test]
fn type_definition_fallback_follows_question_function_method_members() {
    run_type_definition_case(RootKind::Function, MemberKind::Method, true);
}

#[test]
fn type_definition_bridge_follows_question_static_field_members() {
    run_type_definition_case(RootKind::Static, MemberKind::Field, false);
}

#[test]
fn type_definition_fallback_follows_question_static_field_members() {
    run_type_definition_case(RootKind::Static, MemberKind::Field, true);
}

#[test]
fn type_definition_bridge_follows_question_static_method_members() {
    run_type_definition_case(RootKind::Static, MemberKind::Method, false);
}

#[test]
fn type_definition_fallback_follows_question_static_method_members() {
