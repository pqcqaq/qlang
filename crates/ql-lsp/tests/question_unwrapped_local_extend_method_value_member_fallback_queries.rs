...
#[test]
fn dependency_field_queries_work_on_question_unwrapped_local_extend_method_result_receivers_without_semantic_analysis(
) {
    let temp = TempDir::new("ql-lsp-question-unwrapped-local-extend-method-value-member-query-broken");
...
"#;
    ...
    .expect("dependency extend-method-result local member hover should exist without semantic analysis");
    ...
    .expect("dependency extend-method-result local member definition should exist without semantic analysis");
    ...
    .expect("dependency extend-method-result local member declaration should exist without semantic analysis");
    ...
    .expect("dependency extend-method-result local member references should exist without semantic analysis");
    ...
    .expect("dependency extend-method-result local member references should exist without declaration");
