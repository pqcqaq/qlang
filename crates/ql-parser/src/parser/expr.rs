    ...
    fn parse_binary_expr(
        ...
        loop {
            let (op, prec, right_assoc) = match self.current().kind {
                ...
                TokenKind::PipePipe => (BinaryOp::OrOr, 2, false),
                TokenKind::AmpAmp => (BinaryOp::AndAnd, 3, false),
                TokenKind::EqEq => (BinaryOp::EqEq, 4, false),
                TokenKind::BangEq => (BinaryOp::BangEq, 4, false),
                ...
                TokenKind::Minus => (BinaryOp::Sub, 6, false),
                TokenKind::Star => (BinaryOp::Mul, 7, false),
                TokenKind::Slash => (BinaryOp::Div, 7, false),
                TokenKind::Percent => (BinaryOp::Rem, 7, false),
                _ => break,
            };
