...
- `std.core`: integer and boolean helpers such as `max_int`, `min_int`, `clamp_int`, `clamp_min_int`, `clamp_max_int`, `abs_int`, `abs_diff_int`, `sign_int`, `compare_int`, `is_zero_int`, `is_nonzero_int`, `is_positive_int`, `is_nonnegative_int`, `is_negative_int`, `is_nonpositive_int`, `is_even_int`, `is_odd_int`, `in_range_int`, `in_exclusive_range_int`, `is_divisible_by_int`, `is_within_int`, `bool_to_int`, `not_bool`, `and_bool`, `or_bool`, `xor_bool`, and `implies_bool`.
