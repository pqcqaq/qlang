...
- `std.option`: executable generic carrier `Option[T]` plus concrete `IntOption` / `BoolOption` helpers `some_int`, `none_int`, `is_some_int`, `is_none_int`, `unwrap_or_int`, `or_int`, `or_option_int`, `value_or_zero_int`, `some_bool`, `none_bool`, `is_some_bool`, `is_none_bool`, `unwrap_or_bool`, `or_option_bool`, `value_or_false_bool`, and `value_or_true_bool`.
