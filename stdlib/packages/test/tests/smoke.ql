...
fn main() -> Int {
    ...
    let generic_array_eq_status = sum_statuses([check_int(expect_array_eq(["red", "blue", "green"], ["red", "blue", "green"]), 0), check_int(expect_array_eq([1, 2, 3, 4], [1, 2, 3, 4]), 0), check_int(expect_array_eq([true, false, true], [true, false, true]), 0), check_int(expect_array_eq([0 - 3, 0, 3], [0 - 3, 0, 3]), 0)])
    ...
    let bool_large_aggregate_pass = sum_statuses([check_int(expect_bool_array_all([true, true, true, true, true], true), 0), check_int(expect_bool_array_any([false, false, false, false, true], true), 0), check_int(expect_bool_array_all([true], true), 0), check_int(expect_bool_array_any([false], false), 0)])
    let bool_none_pass = sum_statuses([check_int(expect_bool_array_none([false, false, false], true), 0), check_int(expect_bool_array_none([false, false, true, false], false), 0), check_int(expect_bool_array_none([false, false, false, false, false], true), 0), check_int(expect_bool_array_none([false], true), 0)])
    let bool_conversion_pass = sum_statuses([check_int(expect_bool_to_int(true, 1), 0), check_int(expect_bool_to_int(false, 0), 0)])
    ...
    let bool_large_aggregate_failure = sum_statuses([check_int(expect_bool_array_all([true, true, true, true, false], true), 1), check_int(expect_bool_array_any([false, false, false, false, false], true), 1), check_int(expect_bool_array_all([false], true), 1), check_int(expect_bool_array_any([true], false), 1)])
    let bool_none_failure = sum_statuses([check_int(expect_bool_array_none([false, true, false], true), 1), check_int(expect_bool_array_none([false, false, false, false], false), 1), check_int(expect_bool_array_none([false, false, true, false, false], true), 1), check_int(expect_bool_array_none([true], true), 1)])
    let bool_conversion_failure = sum_statuses([check_int(expect_bool_to_int(false, 1), 1), check_int(expect_bool_to_int(true, 0), 1)])
    ...
    let order_pass = sum_statuses([check_int(expect_int_array_strictly_ascending([3, 5, 9]), 0), check_int(expect_int_array_strictly_descending([9, 5, 3]), 0), check_int(expect_int_array_ascending([0 - 9, 0 - 9, 0 - 1]), 0), check_int(expect_int_array_descending([0 - 1, 0 - 1, 0 - 9]), 0)])
    ...
    let order_failure = sum_statuses([check_int(expect_int_array_strictly_ascending([3, 3, 9]), 1), check_int(expect_int_array_strictly_descending([9, 9, 3]), 1), check_int(expect_int_array_ascending([0 - 3, 0 - 9, 0 - 1]), 1), check_int(expect_int_array_descending([0 - 7, 0 - 1, 0 - 5]), 1)])
    ...
    let transform_bound_pass = sum_statuses([check_int(expect_int_upper_bound(9, 3, 9), 0), check_int(expect_int_upper_bound(3, 9, 9), 0), check_int(expect_int_lower_bound(9, 3, 3), 0), check_int(expect_int_lower_bound(3, 9, 3), 0)])
    ...
    let transform_bound_failure = sum_statuses([check_int(expect_int_upper_bound(9, 3, 3), 1), check_int(expect_int_upper_bound(3, 9, 3), 1), check_int(expect_int_lower_bound(9, 3, 9), 1), check_int(expect_int_lower_bound(3, 9, 9), 1)])
    ...
    let transform_clamp_pass = sum_statuses([check_int(expect_int_clamp_min(19, 20, 20), 0), check_int(expect_int_clamp_max(23, 22, 22), 0), check_int(expect_int_clamp_min(21, 20, 21), 0), check_int(expect_int_clamp_max(21, 22, 21), 0)])
    let transform_clamp_failure = sum_statuses([check_int(expect_int_clamp_min(19, 20, 19), 1), check_int(expect_int_clamp_max(23, 22, 23), 1), check_int(expect_int_clamp_min(21, 20, 20), 1), check_int(expect_int_clamp_max(21, 22, 22), 1)])
    ...
    let aggregate_large_pass = sum_statuses([check_int(expect_int_array_sum([2, 3, 4, 5, 6], 20), 0), check_int(expect_int_array_product([2, 3, 4, 5, 6], 720), 0), check_int(expect_int_array_sum([0 - 2, 3, 4], 5), 0), check_int(expect_int_array_product([0 - 2, 3, 4], 0 - 24), 0)])
    ...
    let aggregate_large_failure = sum_statuses([check_int(expect_int_array_sum([2, 3, 4, 5, 6], 21), 1), check_int(expect_int_array_product([2, 3, 4, 5, 6], 721), 1), check_int(expect_int_array_sum([0 - 2, 3, 4], 4), 1), check_int(expect_int_array_product([0 - 2, 3, 4], 24), 1)])
    ...
    let division_bool_pass = sum_statuses([check_int(expect_int_has_remainder(22, 7), 0), check_int(expect_int_factor_of(7, 21), 0), check_int(expect_int_divisible_by(21, 7), 0), check_int(expect_int_has_remainder(22, 5), 0)])
    ...
    let division_zero_failure = sum_statuses([check_int(expect_int_quotient_or_zero(21, 0, 1), 1), check_int(expect_int_remainder_or_zero(21, 0, 1), 1), check_int(expect_int_divisible_by(21, 0), 1), check_int(expect_int_factor_of(0, 21), 1)])
    ...
    let compare_sign_more_pass = sum_statuses([check_int(expect_int_compare(9, 9, 0), 0), check_int(expect_int_compare(9, 3, 1), 0), check_int(expect_int_sign(0, 0), 0), check_int(expect_int_sign(5, 1), 0)])
    let compare_sign_failure = sum_statuses([check_int(expect_int_sign(5, 0 - 1), 1), check_int(expect_int_compare(9, 9, 1), 1), check_int(expect_int_compare(3, 9, 1), 1), check_int(expect_int_sign(0, 1), 1)])
    ...
    let extrema_median_pass = sum_statuses([check_int(expect_int_array_max([20, 22, 21, 19], 22), 0), check_int(expect_int_array_min([20, 22, 21, 19], 19), 0), check_int(expect_eq(median_ints([22, 20, 21]), 21), 0), check_int(expect_eq(median_ints([22, 20, 21, 19]), 21), 0)])
    let extrema_large_pass = sum_statuses([check_int(expect_int_array_max([20, 22, 21, 19, 23], 23), 0), check_int(expect_int_array_min([20, 22, 21, 19, 23], 19), 0), check_int(expect_int_array_max([0 - 5, 0 - 2, 0 - 9], 0 - 2), 0), check_int(expect_int_array_min([0 - 5, 0 - 2, 0 - 9], 0 - 9), 0)])
    ...
    let extrema_median_failure = sum_statuses([check_int(expect_int_array_max([20, 22, 21, 19], 21), 1), check_int(expect_int_array_min([20, 22, 21, 19], 20), 1), check_int(expect_eq(median_ints([22, 20, 21]), 22), 1), check_int(expect_eq(median_ints([22, 20, 21, 19]), 20), 1)])
    let extrema_large_failure = sum_statuses([check_int(expect_int_array_max([20, 22, 21, 19, 23], 22), 1), check_int(expect_int_array_min([20, 22, 21, 19, 23], 20), 1), check_int(expect_int_array_max([0 - 5, 0 - 2, 0 - 9], 0 - 5), 1), check_int(expect_int_array_min([0 - 5, 0 - 2, 0 - 9], 0 - 2), 1)])
    ...
    let status_merge_large = sum_statuses([check_int(merge_statuses([1, 2, 3, 4, 5, 6]), 21), check_int(merge_statuses([1, 2, 3, 4, 5, 6, 7]), 28), check_int(expect_bool_implies(false, false), 0), check_int(expect_bool_implies(false, true), 0)])
    ...
    let sign_boundary = sum_statuses([check_int(expect_int_nonpositive(0), 0), check_int(expect_int_nonpositive(1), 1), check_int(expect_bool_implies(true, false), 1), check_int(expect_bool_implies(true, true), 0)])
    ...
    let option_or_status = sum_statuses([check_int(expect_option_or(none_int_option, Option.Some(9), 9), 0), check_int(expect_option_or(none_bool_option, Option.Some(false), false), 0), check_int(expect_option_or(Option.Some(7), Option.Some(9), 7), 0), check_int(expect_option_or(Option.Some(true), Option.Some(false), true), 0)])
    ...
    let result_or_status = sum_statuses([check_int(expect_result_or(err_int_five, ok_int_result_eleven, 11), 0), check_int(expect_result_or(err_bool_six, ok_bool_result_false, false), 0), check_int(expect_result_or(ok_int_result_seven, ok_int_result_eleven, 7), 0), check_int(expect_result_or(ok_bool_result_true, ok_bool_result_false, true), 0)])
    let result_error_value_status = sum_statuses([check_int(expect_result_error(ok_int_result_seven, 5, 5), 0), check_int(expect_result_error(err_int_three, 9, 3), 0), check_int(expect_result_error(ok_bool_result_true, 6, 6), 0), check_int(expect_result_error(err_bool_four, 8, 4), 0)])
    ...
    let result_error_value_failure = sum_statuses([check_int(expect_result_error(ok_int_result_seven, 5, 6), 1), check_int(expect_result_error(err_int_three, 9, 4), 1), check_int(expect_result_error(ok_bool_result_true, 6, 7), 1), check_int(expect_result_error(err_bool_four, 8, 5), 1)])
    ...
    let generic_array_bool_aggregate_status = sum_statuses([check_int(expect_bool_array_all([true, true, true], true), 0), check_int(expect_bool_array_any([false, false, true, false], true), 0), check_int(expect_bool_array_none([false, false, false, false, false], true), 0), check_int(expect_bool_array_none([true, false], false), 0)])
