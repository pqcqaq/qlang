...
use std.test.expect_bool_array_reverse3 as expect_bool_array_reverse3
use std.test.expect_bool_array_reverse4 as expect_bool_array_reverse4
use std.test.expect_bool_array_reverse5 as expect_bool_array_reverse5
