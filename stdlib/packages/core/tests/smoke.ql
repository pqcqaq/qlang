...
fn main() -> Int {
    ...
    let order5_status = sum6(check_bool(is_descending_ints([9, 7, 7, 3]), true), check_bool(is_descending_ints([11, 9, 7, 7, 3]), true), check_bool(is_strictly_descending_ints([9, 7, 5, 3]), true), check_bool(is_strictly_descending_ints([11, 9, 7, 5, 3]), true), check_bool(is_strictly_descending_ints([9, 7, 7, 3]), false), check_bool(is_strictly_descending_ints([11, 9, 7, 7, 3]), false))
    ...
    let aggregate_status = sum6(check_int(sum_ints([2, 3, 4]), 9), check_int(sum_ints([2, 3, 4, 5]), 14), check_int(sum_ints([2, 3, 4, 5, 6]), 20), check_int(product_ints([2, 3, 4]), 24), check_int(product_ints([2, 3, 4, 5]), 120), check_int(product_ints([2, 3, 4, 5, 6]), 720))
    let average_status = sum6(check_int(average_ints([5, 8]), 6), check_int(average_ints([3, 6, 9]), 6), check_int(average_ints([2, 4, 6, 8]), 5), check_int(average_ints([2, 4, 6, 8, 10]), 6), 0, 0)
