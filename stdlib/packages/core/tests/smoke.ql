...
fn main() -> Int {
    let extrema_status = sum6(check_int(max3_int(3, 9, 5), 9), check_int(max4_int(3, 9, 5, 7), 9), check_int(min3_int(3, 9, 5), 3), check_int(min4_int(3, 9, 5, 7), 3), check_int(median3_int(9, 3, 5), 5), check_int(compare_int(9, 3), 1))
    ...
    let boundary_status = sum6(check_int(distance_to_range_int(5, 3, 9), 0), check_int(distance_to_bounds_int(5, 9, 3), 0), check_int(sign_int(0 - 5), 0 - 1), check_int(sign_int(0), 0), check_int(sign_int(5), 1), 0)
