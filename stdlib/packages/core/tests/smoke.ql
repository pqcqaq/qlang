...
fn main() -> Int {
    ...
    let compare_status = sum_statuses([check_int(median_ints([9, 3, 5]), 5), check_int(median_ints([9, 3, 5, 7]), 7), check_int(compare_int(9, 3), 1), check_int(compare_int(3, 9), 0 - 1), check_int(compare_int(9, 9), 0), check_int(median_ints([9, 3, 5, 7, 11]), 7)])
    ...
    let generic_strict_order_status = sum_statuses([check_bool(is_strictly_descending_ints([13, 11, 9, 7, 5, 3]), true), check_bool(is_strictly_descending_ints([13, 11, 11, 7, 5, 3]), false), check_bool(is_ascending_ints([2, 3, 4, 5, 6, 7]), true), check_bool(is_descending_ints([7, 6, 5, 4, 3, 2]), true), check_bool(is_ascending_ints([0 - 5, 0 - 5, 0 - 1]), true), check_bool(is_descending_ints([0 - 1, 0 - 5, 0 - 5]), true)])
    ...
    let average_status = sum_statuses([check_int(average_ints([5, 8]), 6), check_int(average_ints([3, 6, 9]), 6), check_int(average_ints([2, 4, 6, 8]), 5), check_int(average_ints([2, 4, 6, 8, 10]), 6), check_int(average_ints([0 - 6, 0 - 3]), 0 - 4), check_int(average_ints([0 - 9, 0, 9]), 0)])
    let generic_aggregate_status = sum_statuses([check_int(sum_ints([2, 3, 4, 5]), 14), check_int(product_ints([2, 3, 4]), 24), check_int(max_ints([3, 9, 5, 7]), 9), check_int(min_ints([3, 9, 5, 7]), 3), check_int(average_ints([2, 4, 6, 8]), 5), check_int(sum_ints([0 - 2, 3, 4]), 5)])
    ...
    let bool_none_status = sum_statuses([check_bool(none_bools([false, false, false]), true), check_bool(none_bools([false, false, true, false]), false), check_bool(none_bools([false, false, false, false, false]), true), check_bool(none_bools([true]), false), check_bool(none_bools([false, true, false, true]), false), check_bool(none_bools([false]), true)])
