...
fn main() -> Int {
    ...
    return int_status + bool_status + check_int(unwrap_result_or_int(or_result_int(err_int(5), ok_int(11)), 0), 11) + check_bool(unwrap_result_or_bool(or_result_bool(err_bool(6), ok_bool(false)), true), false)
}
