...
fn front_back_status() -> Int {
    let int_status = sum_statuses([check_int(first_array([2, 3, 4]), 2), check_int(first_array([2, 3, 4, 5]), 2), check_int(first_array([2, 3, 4, 5, 6]), 2), check_int(last_array([2, 3, 4]), 4), check_int(last_array([2, 3, 4, 5]), 5), check_int(last_array([2, 3, 4, 5, 6]), 6)])
    let bool_status = sum_statuses([check_bool(first_array([true, false, false]), true), check_bool(first_array([false, true, true, true]), false), check_bool(first_array([true, false, true, false, true]), true), check_bool(last_array([true, false, true]), true), check_bool(last_array([true, true, false, false]), false), check_bool(last_array([false, true, false, true, false]), false)])
    return int_status + bool_status
}

fn at_status() -> Int {
    let int_status = sum_statuses([check_int(at_array_or([2, 3, 4], 1, 99), 3), check_int(at_array_or([2, 3, 4, 5], 3, 99), 5), check_int(at_array_or([2, 3, 4, 5, 6], 4, 99), 6), check_int(at_array_or([2, 3, 4], 5, 99), 99), check_int(at_array_or([2, 3, 4, 5], 0, 99), 2), check_int(at_array_or([2, 3, 4, 5, 6], 2, 99), 4)])
    let bool_status = sum_statuses([check_bool(at_array_or([true, false, true], 1, true), false), check_bool(at_array_or([false, true, true, false], 3, true), false), check_bool(at_array_or([true, false, true, false, true], 4, false), true), check_bool(at_array_or([true, false, true], 5, false), false), check_bool(at_array_or([false, true, true, false], 0, true), false), check_bool(at_array_or([true, false, true, false, true], 2, false), true)])
    return int_status + bool_status
}
