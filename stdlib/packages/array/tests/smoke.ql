...
fn front_back_status() -> Int {
    ...
    return generic_int_status + generic_bool_status + compatibility_status
}
...
fn at_status() -> Int {
    ...
    return canonical_at_int_status + canonical_at_bool_status + generic_at_int_status + generic_at_bool_status
}

fn len_reverse_repeat_status() -> Int {
    ...
    return generic_len_status + generic_reverse_int_status + generic_repeat_status
}
...
fn contains_count_status() -> Int {
    ...
    let compatibility_string_status = sum6(check_bool(first3_array(["red", "blue", "green"]) == "red", true), check_bool(last5_array(["a", "b", "c", "d", "e"]) == "e", true), check_bool(at4_array_or(["a", "b", "c", "d"], 2, "z") == "c", true), check_bool(at3_array_or(["a", "b", "c"], 9, "fallback") == "fallback", true), check_int(count5_array(["x", "y", "x", "z", "x"], "x"), 3), check_bool(contains5_array(["x", "y", "z", "q", "r"], "none"), false))
    return canonical_contains_status + canonical_count_status + generic_contains_status + generic_count_status + compatibility_string_status
}
...
fn numeric_status() -> Int {
    ...
    return numeric_status + numeric_compatibility_status + extrema_status + extrema_compatibility_status
}
...
fn bool_status() -> Int {
    ...
    return bool_all_status + bool_all_compatibility_status + bool_none_status + bool_none_compatibility_status
}

fn main() -> Int {
    return front_back_status() + at_status() + len_reverse_repeat_status() + contains_count_status() + numeric_status() + bool_status()
}
