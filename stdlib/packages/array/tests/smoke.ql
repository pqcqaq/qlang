...
fn main() -> Int {
    ...
    return generic_int_status + generic_bool_status + generic_at_int_status + generic_at_bool_status + numeric_status + extrema_status + bool_all_status + bool_none_status
}
